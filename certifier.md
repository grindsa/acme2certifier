...
## Prerequisits
 ...
 - you have a user and password to access the certfier via REST-Service
 
## Configuration
 - copy the ca_handler into the acme directory
```
root@rlh:~# cp example\certifier_ca_handler.py acme\ca_handler.py
``` 
...
The response to this call will show a dictionary containing the list of CAs including decription and name. Pick the value in the "name" field.
```
  "offset": 0,
  "limit": 50,
  "totalCount": 3,
...
(policy
  ...
  (accept-request
    ...
    (add-aia
      (null)
      (url http://srv.nclm-samba.local:8090/ca2/))
...
IMPORTANT: the above policy will configure a certificate lifetime of 30 days only. Please review carfully and modify according to your needs.
