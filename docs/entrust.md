...
This handler can be used to enroll certificates from [Entrust ECS Enterprisel](https://www.entrust.com/products/digital-certificates/tls-ssl/entrust-certificate-services).
