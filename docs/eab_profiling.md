...
- ACME accounts created wiht keyid "keyid_03" can use the [pre-validaton domainlist](identifier_prevalidation.md) feature to enroll certificates for "www.example.fi" and "\*.acme" without challenge-validation
