...
Design proposal for running **multiple CA handlers in one acme2certifier instance**, selected per ACME profile and/or EAB kid / eab-profiling. Based on the package layout on `fix_project_structure`.
