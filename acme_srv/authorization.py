...
class Authorization(object):
    ...
    def _authz_info(self, auth_url):
        """ return authzs information """
        self.logger.debug('Authorization._authz_info({0})'.format(auth_url))
        authz_name = auth_url.replace('{0}{1}'.format(self.server_name, self.path_dic['authz_path']), '')
