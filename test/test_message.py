...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_008_message_prepare_response(self, mock_nnonce):
    ...
    @patch('acme_srv.nonce.Nonce.generate_and_add')
    def test_009_message_prepare_response(self, mock_nnonce, mock_error):
    ...
    @patch('acme_srv.error.Error.enrich_error')
    @patch('acme_srv.nonce.Nonce.generate_and_add')
    def test_013_message_prepare_response(self, mock_nnonce, mock_error):
    ...
    def test_014_message__name_get(self):
