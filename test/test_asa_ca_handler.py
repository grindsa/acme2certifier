...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_020__api_get(self, mock_req):
        """ test _api_get() """
        mockresponse = Mock()
        mockresponse.status_code = 'status_code'
        mockresponse.json = lambda: {'foo': 'bar'}
    ...
    @patch('requests.get')
    def test_021__api_get(self, mock_req):
        """ test _api_get() """
        mockresponse = Mock()
        mockresponse.status_code = 'status_code'
        mockresponse.json = "aaaa"
    ...
    def test_025__csr_cn_get(self, mock_cn, mock_san):
        """ test _csr_cn_get() """
    ...
    @patch('examples.ca_handler.asa_ca_handler.csr_san_get')
    @patch('examples.ca_handler.asa_ca_handler.csr_cn_get')
    def test_026__csr_cn_get(self, mock_cn, mock_san):
        """ test _csr_cn_get() """
    ...
    @patch('examples.ca_handler.asa_ca_handler.csr_san_get')
    @patch('examples.ca_handler.asa_ca_handler.csr_cn_get')
    def test_027__csr_cn_get(self, mock_cn, mock_san):
        """ test _csr_cn_get() """
        mock_cn.return_value = None
    ...
    def test_028_issuer_verify(self, mock_list):
        """ _issuer_verify() """
        self.cahandler.ca_name = 'ca_name'
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._issuers_list')
    def test_029_issuer_verify(self, mock_list):
        """ _issuer_verify() """
        self.cahandler.ca_name = 'ca_name'
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._issuers_list')
    def test_030_issuer_verify(self, mock_list):
        """ _issuer_verify() """
        self.cahandler.ca_name = 'ca_name'
    ...
    def test_031_profile_verify(self, mock_list):
        """ _profile_verify() """
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._profiles_list')
    def test_032_profile_verify(self, mock_list):
        """ _profile_verify() """
        self.cahandler.profile_name = 'profile_name'
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._profiles_list')
    def test_033_profile_verify(self, mock_list):
        """ _profile_verify() """
        self.cahandler.ca_name = 'ca_name'
        mock_list.return_value = {'foo': 'bar'}
        with self.assertLogs('test_a2c', level='INFO') as lcm:
    ...
    def test_034__validity_dates_get(self, mock_now, mock_utc):
    ...
    def test_035__pem_cert_chain_generate(self, mock_dec, mock_d2p, mock_b2s):
    ...
    def test_036__pem_cert_chain_generate(self):
        """ test _pem_cert_chain_generate() """
...
"""
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._api_get')
    def test_037___issuer_chain_get(self, mock_req, mock_pem):
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._pem_cert_chain_generate')
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._api_get')
    def test_038___issuer_chain_get(self, mock_req, mock_pem):
        """ test _issuer_chain_get() """
    ...
    def test_039_enroll(self, mock_iv, mock_pv, mock_icg, mock_cpg, mockccg, mock_vdg, mock_csbg, mock_b64, mock_d2p, mock_b2s, mock_post):
        """ test enroll() """
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._profile_verify')
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._issuer_verify')
    def test_040_enroll(self, mock_iv, mock_pv, mock_icg, mock_cpg, mockccg, mock_vdg, mock_csbg, mock_b64, mock_d2p, mock_b2s, mock_post):
        """ test enroll() """
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._profile_verify')
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._issuer_verify')
    def test_041_enroll(self, mock_iv, mock_pv, mock_icg, mock_cpg, mockccg, mock_vdg, mock_csbg, mock_b64, mock_d2p, mock_b2s, mock_post):
        """ test enroll() """
        mock_iv.return_value = None
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._profile_verify')
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._issuer_verify')
    def test_042_enroll(self, mock_iv, mock_pv, mock_icg, mock_cpg, mockccg, mock_vdg, mock_csbg, mock_b64, mock_d2p, mock_b2s, mock_post):
        """ test enroll() """
        mock_iv.return_value = None
        mock_pv.return_value = None
        mock_icg.return_value = 'issuer_chain'
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._profile_verify')
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._issuer_verify')
    def test_043_enroll(self, mock_iv, mock_pv, mock_icg, mock_cpg, mockccg, mock_vdg, mock_csbg, mock_b64, mock_d2p, mock_b2s, mock_post):
        """ test enroll() """
        mock_iv.return_value = None
        mock_pv.return_value = None
        mock_icg.return_value = 'issuer_chain'
    ...
    def test_044_revoke(self, mock_serial, mock_post):
        """ test revoke() """
        self.cahandler.ca_name = 'ca_name'
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._api_post')
    @patch('examples.ca_handler.asa_ca_handler.cert_serial_get')
    def test_045_revoke(self, mock_serial, mock_post):
        """ test revoke() """
        self.cahandler.ca_name = 'ca_name'
        mock_serial.return_value = 'serial'
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._api_post')
    @patch('examples.ca_handler.asa_ca_handler.cert_serial_get')
    def test_046_revoke(self, mock_serial, mock_post):
        """ test revoke() """
        self.cahandler.ca_name = 'ca_name'
        mock_serial.return_value = 'serial'
        mock_post.return_value = ('code', {'Message': 'Message'})
    ...
    @patch('examples.ca_handler.asa_ca_handler.CAhandler._api_post')
    @patch('examples.ca_handler.asa_ca_handler.cert_serial_get')
    def test_047_revoke(self, mock_serial, mock_post):
        """ test revoke() """
        self.cahandler.ca_name = 'ca_name'
        mock_serial.return_value = 'serial'
    ...
    def test_048_config_user_load(self):
    ...
    @patch.dict('os.environ', {'api_user_var': 'user_var'})
    def test_049_config_user_load(self):
        """ test _config_load - load template with user variable """
    ...
    @patch.dict('os.environ', {'api_user_var': 'user_var'})
    def test_050_config_user_load(self):
        """ test _config_load - load template with user variable """
    ...
    def test_051_config_host_load(self):
    ...
    @patch.dict('os.environ', {'api_host_var': 'host_var'})
    def test_052_config_host_load(self):
        """ test _config_load - load template with host variable """
    ...
    @patch.dict('os.environ', {'api_host_var': 'host_var'})
    def test_053_config_host_load(self):
        """ test _config_load - load template with host variable """
    ...
    def test_054_config_key_load(self):
    ...
    @patch.dict('os.environ', {'api_key_var': 'key_var'})
    def test_055_config_key_load(self):
        """ test _config_load - load template with key variable """
    ...
    @patch.dict('os.environ', {'api_key_var': 'key_var'})
    def test_056_config_key_load(self):
        """ test _config_load - load template with key variable """
    ...
    def test_057_config_password_load(self):
    ...
    @patch.dict('os.environ', {'api_password_var': 'password_var'})
    def test_058_config_password_load(self):
        """ test _config_load - load template with password variable """
    ...
    @patch.dict('os.environ', {'api_password_var': 'password_var'})
    def test_059_config_password_load(self):
        """ test _config_load - load template with password variable """
