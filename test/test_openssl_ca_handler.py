...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_007_check_config(self, mock_file):
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler._config_check_crl(): issuing_ca_crl foo.pem does not exist.",
            lcm.output,
        )
    ...
    def test_010_check_config(self, mock_file):
        ...
        self.assertEqual(
            "ca_cert_chain_list must be specified in config file",
            self.cahandler._config_check(),
        )
    ...
    def test_093_config_load(self, mock_load_cfg):
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler._config_load() overwrite issuing_ca_key_passphrase_variable",
            lcm.output,
        )
    ...
    def test_116__cert_extension_dic_parse(
    ...
    @patch("examples.ca_handler.openssl_ca_handler.KeyUsage")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_117__cert_extension_dic_parse(
        self, mock_bc, mock_ku, mock_ski, mock_aki, mock_eku
    ):
        """test _cert_extension_dic_parse()"""
        cert = Mock()
        ...
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual(
                result,
                self.cahandler._cert_extension_dic_parse(
                    cert_extension_dic, cert, cert
                ),
            )
        self.assertIn(
            "INFO:test_a2c:CAhandler.cert_extesion_dic_parse(): basicConstraints",
            lcm.output,
        )
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_118__cert_extension_dic_parse(
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler.cert_extesion_dic_parse(): subjectKeyIdentifier",
            lcm.output,
        )
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_119__cert_extension_dic_parse(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
        """test _cert_extension_dic_parse()"""
        cert = Mock()
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler.cert_extesion_dic_parse(): authorityKeyIdentifier",
            lcm.output,
        )
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_120__cert_extension_dic_parse(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
        """test _cert_extension_dic_parse()"""
        cert = Mock()
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler.cert_extesion_dic_parse(): keyUsage", lcm.output
        )
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_121__cert_extension_dic_parse(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
        """test _cert_extension_dic_parse()"""
        cert = Mock()
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler.cert_extesion_dic_parse(): extendedKeyUsage",
            lcm.output,
        )
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_123__cert_extension_default(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_124__cert_extension_default(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
        """test _cert_extension_default()"""
        cert = Mock()
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_125__cert_extension_default(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
        """test _cert_extension_default()"""
        cert = Mock()
    ...
    @patch("examples.ca_handler.openssl_ca_handler.SubjectKeyIdentifier")
    @patch("examples.ca_handler.openssl_ca_handler.BasicConstraints")
    def test_126__cert_extension_default(
        self, mock_bc, mock_ski, mock_aki, mock_ku, mock_eku
    ):
        """test _cert_extension_default()"""
        cert = Mock()
    ...
    def test_135_revoke(
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler.revoke(): load existing crl issuing_ca_crl)",
            lcm.output,
        )
    ...
    def test_136_revoke(
        ...
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual((200, None, None), self.cahandler.revoke("cert"))
        self.assertIn(
            "INFO:test_a2c:CAhandler._crlobject_build(): create new crl issuing_ca_crl)",
            lcm.output,
        )
        self.assertTrue(mock_ca_load.called)
        self.assertTrue(mock_serial.called)
    ...
    def test_138__cacert_expiry_get(
    ...
    @patch("os.path.exists")
    @patch("examples.ca_handler.openssl_ca_handler.x509.load_pem_x509_certificate")
    def test_139__cacert_expiry_get(
        self, mock_certload, mock_exists, mock_exp, mock_now
    ):
        """test _cacert_expiry_get()"""
    ...
    @patch("os.path.exists")
    @patch("examples.ca_handler.openssl_ca_handler.x509.load_pem_x509_certificate")
    def test_140__cacert_expiry_get(
        self, mock_certload, mock_exists, mock_exp, mock_now
    ):
        """test _cacert_expiry_get()"""
        mock_certload.side_effect = ["cert1", "cert2"]
    ...
    @patch("os.path.exists")
    @patch("examples.ca_handler.openssl_ca_handler.x509.load_pem_x509_certificate")
    def test_141__cacert_expiry_get(
        self, mock_certload, mock_exists, mock_exp, mock_now
    ):
        """test _cacert_expiry_get()"""
    ...
    @patch("os.path.exists")
    @patch("examples.ca_handler.openssl_ca_handler.x509.load_pem_x509_certificate")
    def test_142__cacert_expiry_get(
        self, mock_certload, mock_exists, mock_exp, mock_now
    ):
        """test _cacert_expiry_get()"""
        mock_certload.side_effect = ["cert1", "issuing_ca_cert"]
    ...
    @patch("os.path.exists")
    @patch("examples.ca_handler.openssl_ca_handler.x509.load_pem_x509_certificate")
    def test_143__cacert_expiry_get(
        self, mock_certload, mock_exists, mock_exp, mock_now
    ):
        """test _cacert_expiry_get()"""
        mock_certload.side_effect = ["cert1", "cert2"]
    ...
    def test_148__certexpiry_date_set(self, mock_default, mock_get):
        ...
        self.assertIn(
            "INFO:test_a2c:CAhandler._certexpiry_date_set(): adjust validity to 20 days.",
            lcm.output,
        )
        self.assertTrue(mock_default.called)
        self.assertTrue(mock_get.called)
