...
class TestACMEHandler(unittest.TestCase):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._cert_search')
    @patch('cryptography.x509.load_der_x509_certificate')
    def test_056_pemcertchain_generate(self, mock_load, mock_search, mock_b64dec):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_close')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_open')
    def test_072_rev_insert(self, mock_open, mock_close):
    ...
    def test_073_revoke(self, mock_date):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._ca_load')
    @patch('examples.ca_handler.xca_ca_handler.uts_to_date_utc')
    def test_078_revoke(self, mock_date, mock_ca, mock_serial, mock_rev_insert, mock_search):
        """ CAhandler.revocation no serial """
        self.cahandler.xdb_file = self.dir_path + '/ca/acme2certifier.xdb'
        mock_date.return_value = 'foo'
        mock_ca.return_value = ('key', 'cert', 2)
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._utf_stream_parse')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._stream_split')
    def test_115__template_parse(self, mock_split, mock_utf, mock_valid):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._asn1_stream_parse')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._stream_split')
    def test_116__template_parse(self, mock_split, mock_asn):
        """ __template_parse() - no asn1_stream returned """
        byte_string = 'foo'
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._stream_split')
    def test_117__template_parse(self, mock_split):
        """ __template_parse() - no asn1_stream returned """
        byte_string = 'foo'
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._asn1_stream_parse')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._stream_split')
    def test_119__template_parse(self, mock_split, mock_asn, mock_utf, mock_valid):
    ...
    def test_127__kue_generate(self):
        ...
        kup = 0
        result = {'digital_signature': True, 'content_commitment': True, 'key_encipherment': True, 'data_encipherment': False, 'key_agreement': True, 'key_cert_sign': False, 'crl_sign': False, 'encipher_only': False, 'decipher_only': False}
        with self.assertLogs('test_a2c', level='INFO') as lcm:
    ...
    def test_132__kue_generate(self):
        ...
        kup = 4
        result = {'digital_signature': False, 'content_commitment': False, 'key_encipherment': True, 'data_encipherment': False, 'key_agreement': False, 'key_cert_sign': False, 'crl_sign': False, 'encipher_only': False, 'decipher_only': False}
        with self.assertLogs('test_a2c', level='INFO') as lcm:
    ...
    def test_134___keyusage_generate(self, mock_kuegen):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._kue_generate')
    def test_135___keyusage_generate(self, mock_kuegen):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._config_load')
    def test_143__enter__(self, mock_cfg):
        """ test enter """
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._item_insert')
    def test_147__store_cert(self, mock_i_insert, mock_c_insert):
        """ test insert """
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_close')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_open')
    def test_148_revocation_search(self, mock_open, mock_close, mock_dicfrow):
        """ revocation search  """
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_close')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_open')
    def test_149_revocation_search(self, mock_open, mock_close, mock_dicfrow):
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_close')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_open')
    def test_150_revocation_search(self, mock_open, mock_close, mock_dicfrow):
        """ revocation search  """
        mock_dicfrow.return_value = {'foo': 'bar'}
        mock_open.return_value = True
        mock_close.return_value = True
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_close')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._db_open')
    def test_151_revocation_search(self, mock_open, mock_close, mock_dicfrow):
        """ revocation search  dicfromrow throws exception """
        mock_dicfrow.side_effect = Exception('exc_dicfromrow')
        mock_open.return_value = True
        mock_close.return_value = True
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._cert_insert')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._item_insert')
    def test_152__store_cert(self, mock_i_insert, mock_c_insert):
        """ test insert """
        mock_i_insert.return_value = 1
        mock_c_insert.return_value = 2
        self.cahandler._store_cert('ca_id', 'cert_name', 'serial', 'cert', 'name_hash', 'issuer_hash')
    ...
    def test_153___extended_keyusage_generate(self):
    ...
    def test_154___extended_keyusage_generate(self):
    ...
    def test_155___extended_keyusage_generate(self):
    ...
    def test_156__extended_keyusage_generate(self):
    ...
    def test_159___extended_keyusage_generate(self):
        ...
        with self.assertLogs('test_a2c', level='INFO') as lcm:
            self.assertEqual((False, ['eKeyUse']), self.cahandler._extended_keyusage_generate(template_dic, csr_extensions_dic))
        self.assertIn('ERROR:test_a2c:CAhandler._extended_keyusage_generate(): convert to int failed defaulting ekuc to False', lcm.output)
    ...
    def test_160___extended_keyusage_generate(self):
        ...
        csr_extensions_dic = {}
        self.assertEqual((True, []), self.cahandler._extended_keyusage_generate(template_dic, csr_extensions_dic))

    def test_161__cdp_list_generate(self):
    ...
    def test_162__cdp_list_generate(self, mock_cdp):
        """ test _cdp_list_generate() """
        cdp_string = 'foo'
    ...
    @patch('cryptography.x509.DistributionPoint')
    def test_163__cdp_list_generate(self, mock_cdp):
        """ test _cdp_list_generate() """
        cdp_string = 'foo, bar'
        mock_cdp.side_effect = ['foo1', 'foo2']
        self.assertEqual(['foo1', 'foo2'], self.cahandler._cdp_list_generate(cdp_string))

    @patch('cryptography.x509.Name')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._subject_modify')
    def test_164__cert_subject_generate(self, mock_submod, mock_name):
        """ _cert_subject_generate() """
        req = Mock()
        req.subject = 'subject'
        request_name = 'request_name'
        dn_dic = {}
        self.assertEqual('subject', self.cahandler._cert_subject_generate(req, request_name,dn_dic))
    ...
    def test_165__cert_subject_generate(self, mock_submod, mock_name):
        ...
        request_name = 'request_name'
        dn_dic = {}
        self.assertEqual('mock_name', self.cahandler._cert_subject_generate(req, request_name,dn_dic))
        self.assertFalse(mock_submod.called)
    ...
    def test_166__cert_subject_generate(self, mock_submod, mock_name):
        ...
        request_name = 'request_name'
        dn_dic = {'foo': 'bar'}
        self.assertEqual('mock_submod', self.cahandler._cert_subject_generate(req, request_name,dn_dic))
    ...
    def test_170__extension_list_generate(self, mock_template, mock_extlist, mock_convert):
        ...
        csr_extensions_list = []
        template_dic = {}
        self.assertEqual('mock_extlist', self.cahandler._extension_list_generate(template_dic, cert, csr_extensions_list))
    ...
    def test_171__extension_list_generate(self, mock_template, mock_extlist, mock_convert):
        ...
        self.assertEqual('mock_template', self.cahandler._extension_list_generate(template_dic, cert, csr_extensions_list))
    ...
    def test_172__extension_list_generate(self, mock_template, mock_extlist, mock_convert):
        ...
        template_dic = {}
        self.assertEqual('mock_extlist', self.cahandler._extension_list_generate(template_dic, cert, cert, csr_extensions_list))
        self.assertTrue(mock_extlist.called)
        self.assertFalse(mock_template.called)
    ...
    def test_173__extension_list_generate(self, mock_template, mock_extlist, mock_convert, mock_san):
        ...
        template_dic = {}
        self.assertEqual(['mock_extlist', {'name': 'mock_san', 'critical': False}], self.cahandler._extension_list_generate(template_dic, cert, cert, csr_extensions_list))
        self.assertTrue(mock_extlist.called)
        self.assertFalse(mock_template.called)
        self.assertTrue(mock_convert.called)
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._requestname_get')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._config_check')
    def test_185_enroll(self, mock_chk, mock_reqname, mock_csr, mock_b64, mock_build, mock_ca, mock_sign, mock_prof, mock_adl, mock_db):
        """ test enroll() """
        mock_db.return_value = None
        mock_chk.return_value = None
        mock_reqname.return_value = None
    ...
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._requestname_get')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._config_check')
    def test_191_enroll(self, mock_chk, mock_reqname, mock_csr, mock_b64, mock_build, mock_ca, mock_sign, mock_prof, mock_db):
        """ test enroll() """
        mock_db.return_value = None
        mock_chk.return_value = None
        mock_reqname.return_value = 'request_name'
    ...
    def test_192_cert_sign(self, mock_teml_load, mock_str2byte, mock_load, mock_extlist, mock_hash, mock_store, mock_chain, mock_cvt, mock_b64, mock_builder, mock_ecl):
        """ test cert sign """
        ca_cert = Mock()
        ...
        mock_builder.return_value.not_valid_before.return_value.not_valid_after.return_value.issuer_name.return_value.serial_number.return_value.public_key.return_value.subject_name.return_value.sign.return_value.serial_number = 1234
    ...
    @patch('examples.ca_handler.xca_ca_handler.convert_string_to_byte')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._template_load')
    def test_193_cert_sign(self, mock_teml_load, mock_str2byte, mock_load, mock_extlist, mock_hash, mock_store, mock_chain, mock_cvt, mock_b64, mock_builder, mock_ecl):
        """ test cert sign """
        ca_cert = Mock()
        ca_cert.subject = 'subject'
        mock_hash.return_value = 'mock_hash'
    ...
    @patch('examples.ca_handler.xca_ca_handler.convert_string_to_byte')
    @patch('examples.ca_handler.xca_ca_handler.CAhandler._template_load')
    def test_194_cert_sign(self, mock_teml_load, mock_str2byte, mock_load, mock_extlist, mock_hash, mock_store, mock_chain, mock_cvt, mock_b64, mock_builder):
        """ test cert sign """
        ca_cert = Mock()
        ca_cert.subject = 'subject'
        mock_hash.return_value = 'mock_hash'
    ...
    def test_195_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        ...
        result = [{'name': 'mock_ski', 'critical': False}, {'name': 'mock_aki', 'critical': False}, {'name': 'mock_ku', 'critical': True}]
        self.assertEqual(result, self.cahandler._xca_template_process(template_dic, csr_extensions_dic, cert, cert))
    ...
    def test_196_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        ...
        mock_kug.return_value = (True, {'mock_kug': 'mock_kug'})
        mock_cdp.return_value = ['mock_cdp']
        result = [{'name': 'mock_ski', 'critical': False}, {'name': 'mock_aki', 'critical': False}, {'name': 'mock_ku', 'critical': True}, {'critical': False, 'name': 'mock_eku'}]
        self.assertEqual(result, self.cahandler._xca_template_process(template_dic, csr_extensions_dic, cert, cert))
        self.assertTrue(mock_ku.called)
    ...
    def test_197_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        ...
        mock_kug.return_value = (True, {'mock_kug': 'mock_kug'})
        mock_cdp.return_value = ['mock_cdp']
        result = [{'name': 'mock_ski', 'critical': False}, {'name': 'mock_aki', 'critical': False}, {'name': 'mock_ku', 'critical': True}, {'critical': False, 'name': 'mock_crl'}]
        self.assertEqual(result, self.cahandler._xca_template_process(template_dic, csr_extensions_dic, cert, cert))
        self.assertTrue(mock_ku.called)
        self.assertFalse(mock_eku.called)
        self.assertTrue(mock_ekug.called)
    ...
    def test_198_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        ...
        mock_kug.return_value = (True, {'mock_kug': 'mock_kug'})
        mock_cdp.return_value = ['mock_cdp']
        result = [{'name': 'mock_ski', 'critical': False}, {'name': 'mock_aki', 'critical': False}, {'name': 'mock_ku', 'critical': True}, {'critical': True, 'name': 'mock_bc'}]
        self.assertEqual(result, self.cahandler._xca_template_process(template_dic, csr_extensions_dic, cert, cert))
        self.assertTrue(mock_ku.called)
        self.assertFalse(mock_eku.called)
        self.assertTrue(mock_ekug.called)
    ...
    def test_199_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        ...
        mock_kug.return_value = (True, {'mock_kug': 'mock_kug'})
        mock_cdp.return_value = ['mock_cdp']
        result = [{'name': 'mock_ski', 'critical': False}, {'name': 'mock_aki', 'critical': False}, {'name': 'mock_ku', 'critical': True}, {'critical': False, 'name': 'mock_bc'}]
        self.assertEqual(result, self.cahandler._xca_template_process(template_dic, csr_extensions_dic, cert, cert))
        self.assertTrue(mock_ku.called)
        self.assertFalse(mock_eku.called)
        self.assertTrue(mock_ekug.called)
    ...
    @patch('examples.ca_handler.xca_ca_handler.AuthorityKeyIdentifier')
    @patch('examples.ca_handler.xca_ca_handler.SubjectKeyIdentifier')
    def test_200_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        """ test _xca_template_process() """
        csr_extensions_dic = {}
    ...
    @patch('examples.ca_handler.xca_ca_handler.AuthorityKeyIdentifier')
    @patch('examples.ca_handler.xca_ca_handler.SubjectKeyIdentifier')
    def test_201_xca_template_process(self, mock_ski, mock_aki, mock_ku, mock_eku, mock_crl, mock_bc, mock_kug, mock_cdp, mock_ekug):
        """ test _xca_template_process() """
        csr_extensions_dic = {}
