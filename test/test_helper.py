...
"""
    ...
    def test_106_helper_get_url(self):
    ...
    def test_107_helper_get_url(self):
    ...
    def test_108_helper_get_url(self):
    ...
    def test_152_helper_get_url(self):
    ...
    def test_153_helper_get_url(self):
...
-----END CERTIFICATE-----"""
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_219_logger_setup_syslog(self, mock_load_cfg, mock_syslog):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_220_logger_setup_syslog_disabled_without_address(
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_221_logger_setup_log_file(self, mock_load_cfg, mock_file_handler):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.logging.FileHandler")
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_222_logger_setup_log_file_disabled_without_path(
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.logging.FileHandler")
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_223_logger_setup_log_file_open_failure(
        self, mock_load_cfg, mock_file_handler
    ):
    ...
    def test_224_load_config(self, mock_parser):
        """load config"""
    ...
    def test_227_load_config_logs_path_and_source_once(self):
    ...
    def test_228_load_config_logs_env_source(self):
    ...
    def test_229_log_loaded_acme_srv_cfg_after_deferred_load(self):
    ...
    def test_231_log_response(self):
    ...
    def test_232_log_response(self):
    ...
    def test_233_log_response_redacts_pem_chain(self):
    ...
    def test_234_log_response_redacts_pem_on_custom_path(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_235_log_response_keeps_pem_when_log_cert_content(self, mock_load_config):
    ...
    def test_236_log_response(self):
    ...
    def test_239_log_response_debug_dump_on_4xx(self):
    ...
    def test_240_log_response_debug_dump_on_5xx(self):
    ...
    def test_241_print_debug(self, mock_print):
        """test print_debug"""
        self.print_debug(False, "test")
        self.assertFalse(mock_print.called)

    @patch("builtins.print")
    def test_242_print_debug(self, mock_print):
        """test print_debug"""
        self.print_debug(True, "test")
        self.assertTrue(mock_print.called)

    def test_243_jwk_thumbprint_get(self):
    ...
    def test_244_jwk_thumbprint_get(self, mock_jwk):
    ...
    @patch("jwcrypto.jwk.JWK")
    def test_245_jwk_thumbprint_get(self, mock_jwk):
        """test jwk_thumbprint_get with  pubkey"""
        pub_key = {"pub_key": "pub_key"}
    ...
    def test_246_allowed_gai_family(self, mock_sock):
        """test allowed_gai_family"""
        self.assertTrue(self.allowed_gai_family())

    def test_247_validate_csr(self):
        """patched_create_connection"""
    ...
    def test_248_servercert_get(self, mock_sock, mock_context, mock_cert, mock_convert):
        """test servercert get"""
    ...
    @patch("ssl.SSLContext.wrap_socket")
    @patch("socks.socksocket")
    def test_251_servercert_get(self, mock_sock, mock_context, mock_cert):
    ...
    def test_253_txt_get(self, mock_resolve, mock_res):
    ...
    @patch("dns.resolver.resolve")
    def test_254_txt_get(self, mock_resolve):
        """successful dns-query returning one txt record"""
        resp_obj = Mock()
        resp_obj.strings = ["foo", "bar"]
        mock_resolve.return_value = [resp_obj]
    ...
    @patch("dns.resolver.resolve")
    def test_255_txt_get(self, mock_resolve):
        """successful dns-query returning one txt record"""
        resp_obj1 = Mock()
    ...
    @patch("dns.resolver.resolve")
    def test_256_txt_get(self, mock_resolve):
        """successful dns-query returning one txt record"""
    ...
    def test_261_proxystring_convert(self):
        """convert proxy_string unknown protocol"""
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual(
                (3, "proxy", None),
    ...
    def test_262_proxystring_convert(self):
    ...
    def test_263_proxystring_convert(self):
    ...
    def test_275_handle_exception_keyboard_interrupt(self, mock_excepthook):
    ...
    def test_276_handle_exception_regular_exception(self, mock_logging_exception):
    ...
    @patch("logging.exception")
    def test_277_handle_exception_runtime_error(self, mock_logging_exception):
    ...
    @patch("logging.exception")
    def test_278_handle_exception_type_error(self, mock_logging_exception):
    ...
    @patch("sys.__excepthook__")
    @patch("logging.exception")
    def test_279_handle_exception_keyboard_interrupt_subclass(
    ...
    @patch("logging.exception")
    def test_280_handle_exception_system_exit(self, mock_logging_exception):
    ...
    @patch("logging.exception")
    def test_281_handle_exception_custom_exception(self, mock_logging_exception):
    ...
    def test_285_ca_handler_load(self, mock_imp):
        """test ca_handler_load"""
    ...
    def test_287_ca_handler_load(self, mock_util):
        """test ca_handler_load"""
    ...
    @patch("importlib.import_module")
    @patch("importlib.util")
    def test_288_ca_handler_load(self, mock_util, mock_imp):
        """test ca_handler_load"""
        config_dic = {"CAhandler": {"handler_file": "foo"}}
    ...
    @patch("importlib.import_module")
    @patch("importlib.util")
    def test_289_ca_handler_load(self, mock_util, mock_imp):
        """test ca_handler_load"""
        config_dic = {"CAhandler": {"handler_file": "foo"}}
        mock_util.module_from_spec.side_effect = Exception("exc_mock_util")
        mock_imp.side_effect = Exception("exc_mock_imp")
    ...
    def test_292_eab_handler_load(self):
        """test eab_handler_load with incomplete EABhandler section returns None"""
        config_dic = {"EABhandler": {"foo": "bar"}}
        self.assertFalse(self.eab_handler_load(self.logger, config_dic))

    @patch("importlib.util")
    def test_293_eab_handler_load(self, mock_util):
    ...
    @patch("importlib.util")
    def test_294_eab_handler_load(self, mock_util):
    ...
    @patch("importlib.util")
    def test_295_eab_handler_load(self, mock_util):
    ...
    @patch("importlib.util")
    def test_299_hooks_load(self, mock_util):
        """test hooks load with hooks but no hooks_file in  config_dic"""
        config_dic = {"Hooks": {"hooks_file": "bar"}}
    ...
    @patch("importlib.import_module")
    def test_300_ca_handler_load_module(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_301_eab_handler_load_module(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_302_hooks_load_module(self, mock_imp):
    ...
    @patch("importlib.util")
    def test_303_ca_handler_load_file_deprecated(self, mock_util):
    ...
    @patch("importlib.import_module")
    @patch("importlib.util")
    def test_304_ca_handler_module_preferred_over_file(self, mock_util, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_306_eab_handler_load_info_once(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_307_hooks_load_info_once(self, mock_imp):
    ...
    def test_308_is_filesystem_path(self):
    ...
    @patch("importlib.util")
    def test_309_ca_handler_module_path(self, mock_util):
    ...
    @patch("importlib.import_module")
    def test_310_ca_handler_module_dotted_not_path(self, mock_imp):
    ...
    @patch("importlib.util")
    def test_311_eab_handler_module_path(self, mock_util):
    ...
    @patch("importlib.util")
    def test_312_hooks_module_path(self, mock_util):
    ...
    def test_313_error_dic_get(self):
        """test error_dic_get"""
        result = {
    ...
    def test_316_logger_nonce_modify(self):
        """test _logger_nonce_modify()"""
    ...
    def test_317_logger_certificate_modify(self):
    ...
    def test_318_logger_certificate_modify(self):
        """test _logger_certificate_modify()"""
        data_dic = {"data": "bar"}
        self.assertEqual(
            {"data": " - certificate - "},
    ...
    def test_319_logger_certificate_modify_pem_content(self):
    ...
    def test_325_config_check(self):
        """test config check"""
    ...
    def test_326_helper_cert_cn_get(self):
        """get cn of csr"""
        cert = """MIIDDTCCAfWgAwIBAgIBCjANBgkqhkiG9w0BAQsFADAaMRgwFgYDVQQDEw9mb28u
                ZXhhbXBsZS5jb20wHhcNMTkwMTIwMTY1OTIwWhcNMTkwMjE5MTY1OTIwWjAaMRgw
                FgYDVQQDEw9mb28uZXhhbXBsZS5jb20wggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAw
    ...
    def test_330_logger_challenges_modify(self):
        """test string_sanitize()"""
        unsafe_string = "fooö"
        self.assertEqual("foo", self.string_sanitize(self.logger, unsafe_string))

    def test_331_logger_challenges_modify(self):
        """test string_sanitize()"""
        unsafe_string = "foo    "
        self.assertEqual("foo ", self.string_sanitize(self.logger, unsafe_string))
    ...
    def test_335_pembundle_to_list(self):
        """bundle to list"""
        pembundle_to_list = (
    ...
    def test_336_certid_check(self):
        """test certid_check"""
...
-----END CERTIFICATE-----"""
    ...
    def test_339_certid_hex_get(self):
        """test certid_check"""
        certid = "false"
        renewal_info = "MFswCwYJYIZIAWUDBAIBBCDhge--b3rj6nHHj8meQibXGFcVvj0onqpWgB3_RpbKTQQgrg3PUzRWkYJrgdCT6cdYjDXdXsXqz1sbJgYzBRXV-vQCCCzKhfZA1UFC"
        self.assertEqual(
    ...
    def test_344_ipv6_chk(self):
        """test ipv6_chk()"""
        addr_obj = "foo.bar.local"
        self.assertFalse(self.ipv6_chk(self.logger, addr_obj))

    def test_345_ipv6_chk(self):
        """test ipv6_chk()"""
        addr_obj = "192.168.123.10"
        self.assertFalse(self.ipv6_chk(self.logger, addr_obj))

    def test_346_ipv6_chk(self):
        """test ipv6_chk()"""
        addr_obj = None
        self.assertFalse(self.ipv6_chk(self.logger, addr_obj))

    def test_347_header_info_get(self):
        """header_info_get ()"""
    ...
    def test_348_header_info_get(self):
        """header_info_get ()"""
        models_mock = MagicMock()
    ...
    def test_349_encode_url(self):
        # Test with a simple URL
        url = "www.example.com"
        self.assertEqual(url, self.encode_url(self.logger, url))

    def test_350_encode_url(self):
    ...
    def test_356_cert_aki_get(self):
    ...
    def test_357_cert_aki_get_error_handling(self):
    ...
    def test_358_cert_ski_get_error_handling(self, mock_ext, mock_ski_get):
    ...
    def test_370_validate_ip(self):
        """test validate_ip()"""
        self.assertFalse(self.validate_ip(self.logger, "foo.bar.local"))

    def test_371_validate_ip(self):
        """test validate_ip()"""
        self.assertFalse(self.validate_ip(self.logger, "foo@bar.local"))

    def test_372_validate_ip(self):
        """test validate_ip()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_376_validate_identifier(self, mock_ip, mock_fqdn, mock_email):
        """test validate_identifier"""
        mock_fqdn.return_value = "dns"
        mock_ip.return_value = "ip"
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_377_validate_identifier(self, mock_ip, mock_fqdn, mock_email):
        """test validate_identifier"""
        mock_fqdn.return_value = "dns"
        mock_ip.return_value = "ip"
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_378_validate_identifier(self, mock_ip, mock_fqdn, mock_email):
        """test validate_identifier"""
        mock_fqdn.return_value = "dns"
        mock_ip.return_value = "ip"
    ...
    @patch("acme2certifier.acme_srv.helpers.config.profile_lookup")
    @patch("acme2certifier.acme_srv.helpers.config.header_info_lookup")
    def test_380_client_parameter_validate(self, mock_lookup, mock_profile):
        """test client_parameter_validate"""
        mock_lookup.return_value = "value2"
        cahandler = FakeDBStore()
        self.assertEqual(
    ...
    @patch("acme2certifier.acme_srv.helpers.config.profile_lookup")
    @patch("acme2certifier.acme_srv.helpers.config.header_info_lookup")
    def test_381_client_parameter_validate(self, mock_lookup, mock_profile):
        """test client_parameter_validate"""
    ...
    @patch("acme2certifier.acme_srv.helpers.config.profile_lookup")
    @patch("acme2certifier.acme_srv.helpers.config.header_info_lookup")
    def test_382_client_parameter_validate(self, mock_lookup, mock_profile):
        """test client_parameter_validate"""
    ...
    @patch("acme2certifier.acme_srv.helpers.network.header_info_get")
    def test_386_header_info_lookup(self, mock_info):
        """test header_info_lookup"""
        mock_info.return_value = [
    ...
    @patch("acme2certifier.acme_srv.helpers.network.header_info_get")
    def test_387_header_info_lookup(self, mock_info):
        """test header_info_lookup"""
    ...
    @patch("acme2certifier.acme_srv.helpers.network.header_info_get")
    def test_388_header_info_lookup(self, mock_info):
        """test header_info_lookup"""
    ...
    @patch("acme2certifier.acme_srv.helpers.network.header_info_get")
    def test_389_header_info_lookup(self, mock_info, mock_json):
        """test header_info_lookup"""
    ...
    def test_390_config_headerinfo_load(self):
    ...
    def test_391_config_headerinfo_load(self):
        """test config_headerinfo_load()"""
        config_dic = {"Order": {"header_info_list": '["foo"]'}}
        self.assertEqual("foo", self.config_headerinfo_load(self.logger, config_dic))

    def test_392_config_headerinfo_load(self):
        """test config_headerinfo_load()"""
        config_dic = {"Order": {"header_info_list": "foo"}}
        with self.assertLogs("test_a2c", level="INFO") as lcm:
    ...
    @patch("acme2certifier.acme_srv.helpers.config.eab_handler_load")
    def test_397_config_eab_profile_load(self, mock_eabload):
        """test config_eab_profiling()"""
        config_dic = configparser.ConfigParser()
        config_dic["EABhandler"] = {
            "eab_profiling": True,
    ...
    @patch("acme2certifier.acme_srv.helpers.config.eab_handler_load")
    def test_398_config_eab_profile_load(self, mock_eabload):
        """test config_eab_profiling()"""
        config_dic = configparser.ConfigParser()
        config_dic["EABhandler"] = {
            "eab_profiling": False,
    ...
    @patch("acme2certifier.acme_srv.helpers.config.eab_handler_load")
    def test_399_config_eab_profile_load(self, mock_eabload):
        """test config_eab_profiling()"""
        config_dic = configparser.ConfigParser()
        config_dic["EABhandler"] = {
            "eab_profiling": "aa",
    ...
    def test_400_eab_profile_string_check(self):
    ...
    def test_401_eab_profile_string_check(self):
        """test _eab_profile_string_check()"""
        cahandler = FakeDBStore()
        cahandler.foo = "foo"
        with self.assertLogs("test_a2c", level="INFO") as lcm:
    ...
    def test_402_eab_profile_as_bool(self):
    ...
    def test_403_eab_profile_list_check(self):
    ...
    def test_404_eab_profile_list_check(self, mock_chk):
        """test _eab_profile_list_check()"""
        cahandler = FakeDBStore()
        eabhandler = Mock()
    ...
    def test_406_eab_profile_list_check(self, mock_hifv, mock_chk):
        """test _eab_profile_list_check()"""
        cahandler = FakeDBStore()
        cahandler.foo = "foo"
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    @patch("acme2certifier.acme_srv.helpers.eab.client_parameter_validate")
    def test_407_eab_profile_list_check(self, mock_hifv, mock_chk):
        """test _eab_profile_list_check()"""
        cahandler = FakeDBStore()
        cahandler.foo = "foo"
        cahandler.header_info_field = "header_info_field"
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    def test_408_eab_profile_list_check(self, mock_chk):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    def test_409_eab_profile_list_check(self, mock_chk):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    def test_410_eab_profile_list_check(self, mock_chk):
        """test _eab_profile_list_check() test allowed domain check if eabhandler contains attribute"""
        cahandler = FakeDBStore()
        mock_chk.return_value = False
        cahandler.allowed_domainlist = ["foo", "foobar"]
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_413_eab_profile_header_info_check(
        self, mock_lookup, mock_eab, mock_profile
    ):
        """test eab_profile_header_info_check()"""
        cahandler = FakeDBStore()
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.header_value_allowlist_resolve")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_415_eab_profile_header_info_check(
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_416_eab_profile_header_info_check_allowlist(
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_417_eab_profile_header_info_check_risk_gate(
        self, mock_lookup, mock_eab, mock_allowlist
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_418_eab_profile_header_info_check_not_in_allowlist(
        self, mock_lookup, mock_eab, mock_allowlist
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_419_eab_profile_header_info_check(self, mock_lookup, mock_eab):
        """test eab_profile_header_info_check()"""
        cahandler = FakeDBStore()
        cahandler.eab_profiling = False
        cahandler.header_info_field = "hi_field"
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_420_eab_profile_header_info_check(self, mock_lookup, mock_eab):
        """test eab_profile_header_info_check()"""
        cahandler = FakeDBStore()
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_421_eab_profile_header_info_check(self, mock_lookup, mock_eab):
        """test eab_profile_header_info_check()"""
        cahandler = FakeDBStore()
        cahandler.eab_profiling = True
    ...
    def test_422_eab_profile_check(self, mock_string, mock_list):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_423_eab_profile_check(self, mock_string, mock_list):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
        self.handler_hifield = "testField"
        self.cahandler.eab_handler.return_value.__enter__.return_value.eab_profile_get.return_value = {
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_424_eab_profile_check(self, mock_string, mock_list, mock_hil):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
        self.handler_hifield = "testField"
        self.cahandler.eab_handler.return_value.__enter__.return_value.eab_profile_get.return_value = {
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_425_eab_profile_check(self, mock_string, mock_list, mock_hil):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
        self.handler_hifield = "testField"
        self.cahandler.eab_handler.return_value.__enter__.return_value.eab_profile_get.return_value = {
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_426_eab_profile_check(self, mock_string, mock_list):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
        self.handler_hifield = "testField"
        self.cahandler.eab_handler.return_value.__enter__.return_value.eab_profile_get.return_value = {
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_427_eab_profile_check(self, mock_string, mock_list, mock_subject):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_428_cn_validate(self, mock_ip, mock_fqdn):
        """test cn_validate()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_429_cn_validate(self, mock_ip, mock_fqdn):
        """test cn_validate()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_430_cn_validate(self, mock_ip, mock_fqdn):
        """test cn_validate()"""
        mock_ip.return_value = False
    ...
    @patch("acme2certifier.acme_srv.helpers.validation.validate_fqdn")
    @patch("acme2certifier.acme_srv.helpers.validation.validate_ip")
    def test_431_cn_validate(self, mock_ip, mock_fqdn):
        """test cn_validate()"""
        mock_ip.return_value = False
        mock_fqdn.return_value = False
        self.assertEqual(
    ...
    def test_432_csr_subject_get(self):
    ...
    def test_433_csr_subject_get(self):
        """test csr_subject_get()"""
    ...
    def test_434_csr_subject_get(self):
        """test csr_subject_get()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.cn_validate")
    def test_436_eab_profile_subjet_string_check(self, mock_validate):
        """test eab_profile_subject_string_check()"""
        profile_dic = {"foo": "*"}
        self.assertFalse(
            self.eab_profile_subject_string_check(
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.cn_validate")
    def test_437_eab_profile_subjet_string_check(self, mock_validate):
        """test eab_profile_subject_string_check()"""
        profile_dic = {"foo": "bar"}
        self.assertFalse(
            self.eab_profile_subject_string_check(
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.cn_validate")
    def test_438_eab_profile_subjet_string_check(self, mock_validate):
        """test eab_profile_subject_string_check()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.cn_validate")
    def test_439_eab_profile_subjet_string_check(self, mock_validate):
        """test eab_profile_subject_string_check()"""
        profile_dic = {"foo": ["bar1", "bar2", "bar3"]}
        self.assertFalse(
            self.eab_profile_subject_string_check(
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.cn_validate")
    def test_440_eab_profile_subjet_string_check(self, mock_validate):
        """test eab_profile_subject_string_check()"""
        profile_dic = {"foo": ["bar1", "bar2", "bar3"]}
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.cn_validate")
    def test_441_eab_profile_subjet_string_check(self, mock_validate):
        """test eab_profile_subject_string_check()"""
        profile_dic = {"foo": ["bar1", "bar2", "bar3"]}
        mock_validate.return_value = "error"
        self.assertEqual(
    ...
    def test_442_eab_profile_subject_check(self, mock_cn, mock_strchk):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_subject_string_check")
    @patch("acme2certifier.acme_srv.helpers.eab.csr_subject_get")
    def test_443_eab_profile_subject_check(self, mock_cn, mock_strchk):
        """test eab_profile_subject_check()"""
        profile_dic = {"foo": "bar"}
        mock_cn.return_value = {"o": "o", "ou": "ou", "cn": "cn"}
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_subject_string_check")
    @patch("acme2certifier.acme_srv.helpers.eab.csr_subject_get")
    def test_444_eab_profile_subject_check(self, mock_cn, mock_strchk):
        """test eab_profile_subject_check()"""
        profile_dic = {"foo": "bar"}
        mock_cn.return_value = {"o": "o", "ou": "ou", "cn": "cn"}
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_subject_string_check")
    @patch("acme2certifier.acme_srv.helpers.eab.csr_subject_get")
    def test_445_eab_profile_subject_check(self, mock_cn, mock_strchk):
        """test eab_profile_subject_check()"""
        profile_dic = {"foo": "bar"}
        mock_cn.return_value = {"o": "o", "ou": "ou", "cn": "cn"}
    ...
    def test_446_csr_cn_lookup(self, mock_cnget, mock_san_get):
        """test _csr_cn_lookup()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.csr.csr_san_get")
    @patch("acme2certifier.acme_srv.helpers.csr.csr_cn_get")
    def test_447_csr_cn_lookup(self, mock_cnget, mock_san_get):
        """test _csr_cn_lookup()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.csr.csr_san_get")
    @patch("acme2certifier.acme_srv.helpers.csr.csr_cn_get")
    def test_448_csr_cn_lookup(self, mock_cnget, mock_san_get):
        """test _csr_cn_lookup()"""
        mock_cnget.return_value = None
    ...
    @patch("acme2certifier.acme_srv.helpers.csr.csr_san_get")
    @patch("acme2certifier.acme_srv.helpers.csr.csr_cn_get")
    def test_449_csr_cn_lookup(self, mock_cnget, mock_san_get):
        """test _csr_cn_lookup()"""
        mock_cnget.return_value = None
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_450_request_operation(self, mock_get, mock_post, mock_put):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.post")
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_451_request_operation(self, mock_get, mock_post, mock_put):
        """test request_operation()"""
        mockresponse_get = Mock()
        mockresponse_get.status_code = "status_code"
        mockresponse_get.json = lambda: {"get": "get"}
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.post")
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_452_request_operation(self, mock_get, mock_post, mock_put):
        """test request_operation()"""
        mockresponse_get = Mock()
        mockresponse_get.status_code = "status_code"
        mockresponse_get.json = lambda: {"get": "get"}
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.post")
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_453_request_operation(self, mock_get, mock_post, mock_put):
        """test request_operation()"""
        mockresponse_get = Mock()
        mockresponse_get.status_code = "status_code"
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.post")
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_454_request_operation(self, mock_get, mock_post, mock_put):
        """test request_operation()"""
        mockresponse_get = Mock()
        mockresponse_get.status_code = "status_code"
        mockresponse_get.json = "string"
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.post")
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_455_request_operation(self, mock_get, mock_post, mock_put):
        """test request_operation()"""
        mockresponse_get = Mock()
        mockresponse_get.status_code = "status_code"
        mockresponse_get.json = "string"
    ...
    def test_456_enrollment_config_log(self):
    ...
    def test_457_enrollment_config_log_sensitive_name_fragment(self):
    ...
    def test_458_kerberos_kinit_command_resolve_default(self):
    ...
    def test_459_kerberos_kinit_command_resolve_absolute(self):
    ...
    def test_460_kerberos_kinit_command_resolve_debian_alternatives(self):
    ...
    def test_461_kerberos_kinit_command_resolve_rejects_relative(self):
    ...
    def test_462_kerberos_kinit_command_resolve_rejects_wrong_basename(self):
    ...
    def test_463_kerberos_kinit_command_resolve_rejects_bad_symlink_target(self):
    ...
    def test_464_enrollment_config_log(self):
        """test enrollment_config_log()"""
    ...
    def test_465_enrollment_config_log(self):
        """test enrollment_config_log()"""
    ...
    def test_466_config_enroll_config_log_load(self):
    ...
    def test_467_config_enroll_config_log_load(self):
        """test config_enroll_config_log_load()"""
        config_dic = configparser.ConfigParser()
    ...
    def test_468_config_enroll_config_log_load(self):
        """test config_enroll_config_log_load()"""
        config_dic = configparser.ConfigParser()
    ...
    def test_469_config_enroll_config_log_load(self):
        """test config_enroll_config_log_load()"""
        config_dic = configparser.ConfigParser()
    ...
    def test_470_config_enroll_config_log_load(self):
        """test config_enroll_config_log_load()"""
        config_dic = configparser.ConfigParser()
        config_dic["CAhandler"] = {
            "enrollment_config_log": "True",
    ...
    def test_471_config_allowed_domainlist_load(self):
    ...
    def test_472_config_allowed_domainlist_load(self):
        """test config_allowed_domainlist_load()"""
    ...
    def test_473_config_allowed_domainlist_load(self):
        """test config_allowed_domainlist_load()"""
        config_dic = {"CAhandler": {"allowed_domainlist": "foo"}}
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual(
    ...
    def test_474_domainlist_check(self):
    ...
    def test_480_is_domain_whitelisted(self):
    ...
    @patch("idna.encode")
    def test_487_is_domain_whitelisted(self, mock_idna):
        """exception"""
    ...
    @patch("idna.encode")
    def test_491_is_domain_whitelisted(self, mock_idna):
        """exception"""
        list_ = ["example.com", "*.bar.foo"]
        entry = "foo.bar.foo"
    ...
    def test_492_allowed_domainlist_check(self, mock_san, mock_cn):
    ...
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_cn_get")
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_san_get")
    def test_493_allowed_domainlist_check(self, mock_san, mock_cn):
        """CAhandler._check_csr with empty allowed_domainlist"""
    ...
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_cn_get")
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_san_get")
    def test_494_allowed_domainlist_check(self, mock_san, mock_cn):
    ...
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_cn_get")
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_san_get")
    def test_495_allowed_domainlist_check(self, mock_san, mock_cn):
    ...
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_cn_get")
    @patch("acme2certifier.acme_srv.helpers.domain_utils.csr_san_get")
    def test_496_allowed_domainlist_check(self, mock_san, mock_cn):
        """CAhandler._check_csr with empty allowed_domainlist"""
        allowed_domainlist = ["*.foo.bar"]
    ...
    def test_497_radomize_parameter_list(self, mock_rand):
    ...
    @patch("acme2certifier.acme_srv.helpers.utils.secrets.randbelow")
    def test_498_radomize_parameter_list(self, mock_rand):
        """test radomize_parameter_list()"""
    ...
    @patch("acme2certifier.acme_srv.helpers.utils.secrets.randbelow")
    def test_499_radomize_parameter_list(self, mock_rand):
        """test radomize_parameter_list()"""
    ...
    def test_500_config_profile_load(self):
    ...
    def test_501_config_profile_load(self):
        """test _config_load with unknown values config"""
        parser = configparser.ConfigParser()
    ...
    def test_502_profile_lookup(self):
        """profile_lookup ()"""
        models_mock = MagicMock()
    ...
    def test_503_profile_lookup(self):
        """profile_lookup ()"""
        models_mock = MagicMock()
    ...
    def test_504_profile_lookup(self):
        """profile_lookup ()"""
        models_mock = MagicMock()
        models_mock.DBstore().certificates_search.return_value = [{"foo": "bar"}]
        modules = {"acme2certifier.acme_srv.db_handler": models_mock}
    ...
    def test_505_profile_lookup(self):
        """profile_lookup ()"""
        models_mock = MagicMock()
        models_mock.DBstore().certificates_search.side_effect = Exception("mock_search")
        modules = {"acme2certifier.acme_srv.db_handler": models_mock}
    ...
    def test_506_b64_url_decode(self):
        """test b64_url_decode()"""
        self.assertEqual("foo", self.b64_url_decode(self.logger, "Zm9v"))

    def test_507_b64_url_decode(self):
        """test b64_url_decode()"""
        self.assertEqual(
            "thisisateststring",
    ...
    def test_508_b64_url_decode(self):
        """test b64_url_decode()"""
        self.assertEqual(
            "thisisateststring",
            self.b64_url_decode(self.logger, "dGhpc2lzYXRlc3RzdHJpbmc="),
    ...
    def test_509_b64_url_decode(self):
        """test b64_url_decode()"""
        self.assertEqual(
            "thisisateststring",
            self.b64_url_decode(self.logger, "dGhpc2lzYXRlc3RzdHJpbmc    "),
    ...
    def test_510_eab_profile_revocation_check_str_value(self, mock_b64_url_recode):
    ...
    def test_511_eab_profile_revocation_check_str_and_ignore_value(
    ...
    def test_512_eab_profile_revocation_check_list_value(self, mock_b64_url_recode):
    ...
    def test_513_eab_profile_revocation_check_list_value_fallback(
        self, mock_b64_url_recode
    ):
    ...
    def test_514_missing_required_keys(self):
    ...
    def test_515_all_required_keys_present(self):
        class DummyHandler(object):
            def __init__(self):
                self.vault_url = "url"
    ...
    def test_516_empty_config(self):
        class DummyHandler(object):
            def __init__(self):
                self.vault_url = "url"
                self.vault_token = "token"
    ...
    def test_517_config_proxy_load_valid_config(self, mock_parse_url, mock_proxy_check):
    ...
    def test_518_config_proxy_load_no_default_section(self):
    ...
    def test_519_config_proxy_load_no_proxy_server_list(self):
    ...
    def test_520_config_proxy_load_invalid_json(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_521_config_proxy_load_no_host_in_url(self, mock_parse_url):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.proxy_check")
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_522_config_proxy_load_proxy_check_returns_none(
    ...
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_523_config_proxy_load_parse_url_exception(self, mock_parse_url):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.proxy_check")
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_524_config_proxy_load_host_without_port(
        self, mock_parse_url, mock_proxy_check
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.proxy_check")
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_525_config_proxy_load_empty_proxy_list(
        self, mock_parse_url, mock_proxy_check
    ):
    ...
    def test_526_config_async_mode_load_true_with_django(self):
    ...
    def test_527_config_async_mode_load_true_non_django(self):
    ...
    def test_528_config_async_mode_load_false_with_django(self):
    ...
    def test_529_config_async_mode_load_default_fallback(self):
    ...
    def test_530_config_async_mode_load_no_default_section(self):
        """test config_async_mode_load() with no DEFAULT section"""
        config_dic = configparser.ConfigParser()
        db_type = "django"
        self.assertFalse(self.config_async_mode_load(self.logger, config_dic, db_type))

    def test_531_config_async_mode_load_invalid_boolean(self):
    ...
    def test_532_config_async_mode_load_case_insensitive_true(self):
    ...
    def test_533_config_async_mode_load_case_insensitive_false(self):
    ...
    def test_534_config_async_mode_load_different_db_types(self):
    ...
    def test_535_fqdn_resolve_successful_a_record_no_catch_all(self):
    ...
    def test_536_fqdn_resolve_successful_aaaa_record_no_catch_all(self):
    ...
    def test_537_fqdn_resolve_successful_catch_all_both_records(self):
    ...
    def test_538_fqdn_resolve_nxdomain_error(self):
    ...
    def test_539_fqdn_resolve_no_answer_error(self):
    ...
    def test_540_fqdn_resolve_timeout_error(self):
    ...
    def test_541_fqdn_resolve_generic_error(self):
    ...
    def test_542_fqdn_resolve_mixed_errors_catch_all(self):
    ...
    def test_543_fqdn_resolve_empty_answers_no_catch_all(self):
    ...
    def test_544_fqdn_resolve_empty_answers_catch_all(self):
    ...
    def test_545_fqdn_resolve_partial_success_catch_all(self):
    ...
    def test_546_fqdn_resolve_multiple_a_records_no_catch_all(self):
    ...
    def test_547_fqdn_resolve_a_fails_aaaa_succeeds_no_catch_all(self):
    ...
    def test_548_fqdn_resolve_logging_verification(self):
    ...
    def test_549_ptr_resolve_successful_resolution(self):
    ...
    def test_550_ptr_resolve_successful_with_dns_servers(self):
    ...
    def test_551_ptr_resolve_exception_handling(self):
    ...
    def test_552_ptr_resolve_nxdomain_error(self):
    ...
    def test_553_ptr_resolve_timeout_error(self):
    ...
    def test_554_ptr_resolve_invalid_address_format(self):
    ...
    def test_555_ptr_resolve_empty_response(self):
    ...
    def test_556_ptr_resolve_logging_verification(self):
    ...
    def test_557_ptr_resolve_error_logging_verification(self):
    ...
    def test_558_ptr_resolve_ipv6_address(self):
    ...
    def test_559_url_get_with_default_dns_successful_200(self):
    ...
    def test_560_url_get_with_default_dns_successful_non_200(self):
    ...
    def test_561_url_get_with_default_dns_exception_fallback_success(self):
    ...
    def test_562_url_get_with_default_dns_fallback_read_timeout(self):
    ...
    def test_563_url_get_with_default_dns_fallback_connection_error(self):
    ...
    def test_564_url_get_with_default_dns_fallback_generic_exception(self):
    ...
    def test_565_url_get_with_default_dns_fallback_non_200(self):
    ...
    def test_566_url_get_with_default_dns_with_proxy_config(self):
    ...
    def test_567_url_get_with_default_dns_logging_verification(self):
    ...
    def test_568_allowed_gai_family(self):
    ...
    def test_569_config_allowed_domainlist_load_deprecated_section(self):
    ...
    def test_570_config_allowed_domainlist_load_invalid_json(self):
    ...
    def test_571_pkcs7_to_pem(self):
    ...
    def test_572_pkcs7_to_pem(self):
    ...
    def test_573_pkcs7_to_pem(self):
    ...
    def test_574_pkcs7_to_pem(self):
        """test pkcs7 to pem output list"""
        with open(self.dir_path + "/ca/certs.p7b", "r") as fso:
            file_content = fso.read()
        result = None
    ...
    def test_575_pkcs7_to_pem(self):
        """test pkcs7 to pem output list"""
    ...
    def test_576_pkcs7_to_pem_tag_replacement_logs_error(self):
    ...
    def test_577_pkcs7_to_pem_all_strategies_fail(self):
    ...
    def test_578_config_dryrun_load_not_set(self):
        """Test config_dryrun_load with valid 'true' value."""

    def test_579_config_dryrun_load_not_set(self):
    ...
    def test_580_config_dryrun_load_true(self):
        """Test config_dryrun_load with valid 'true' value."""
        config_dic = configparser.ConfigParser()
    ...
    def test_581_config_dryrun_load_false(self):
    ...
    def test_582_config_dryrun_load_profile(self):
    ...
    def test_583_config_dryrun_load_profile_no_profilename(self):
    ...
    def test_586_is_ip_whitelisted_invalid(self):
    ...
    def test_587_is_ip_whitelisted_invalid(self):
        """Test is_ip_whitelisted with invalid IP list."""
        self.assertFalse(
            self.is_ip_whitelisted(
                self.logger,
    ...
    def test_588_is_ip_whitelisted_no_match(self):
    ...
    def test_589_is_ip_whitelisted_exact_match(self):
    ...
    def test_590_is_ip_whitelisted_cidr_match(self):
    ...
    def test_591_is_ip_whitelisted_cidr_32match(self):
    ...
    def test_592_is_ip_whitelisted_invalid_network(self):
    ...
    def test_593_config_allowed_iplist_load(self):
    ...
    def test_594_config_allowed_iplist_load(self):
        """test config_allowed_iplist_load()"""
    ...
    def test_595_config_allowed_iplist_load(self):
        """test config_allowed_iplist_load()"""
        config_dic = {"Order": {"allowed_iplist": "foo"}}
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual(
    ...
    def test_596_is_email_whitelisted_exact_match(self):
    ...
    def test_597_is_email_whitelisted_case_insensitive(self):
    ...
    def test_598_is_email_whitelisted_not_in_list(self):
        """Test is_email_whitelisted returns False for non-matching email"""
        from acme2certifier.acme_srv.helpers.domain_utils import is_email_whitelisted

        email_list = ["user@example.com", "admin@domain.com"]

    def test_599_is_email_whitelisted_with_whitespace(self):
    ...
    def test_600_email_whitelisted_empty_list(self):
    ...
    def test_601_is_email_whitelisted_exact_match(self):
    ...
    def test_602_is_email_whitelisted_wildcard(self):
    ...
    def test_603_is_email_whitelisted_mixed_patterns(self):
    ...
    def test_604_is_email_whitelisted_strip_and_case(self):
    ...
    def test_605_cert_aki_asn1_get_success_and_missing(self):
    ...
    def test_606_cert_ski_asn1_get_success_and_missing(self):
    ...
    def test_607_cert_aki_asn1_get_missing_key_identifier(self):
    ...
    def test_608_cert_extension_raw_get_no_extensions(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.certificates.x509.Certificate.extensions")
    def test_609_cert_aki_get_falls_back_to_asn1(self, mock_ext, mock_aki_get):
    ...
    def test_610_default_deploy_base_dir_and_resolve_config_path(self):
    ...
    def test_611_warn_acme_srv_cfg_path_once(self):
    ...
    def test_612_default_acme_srv_cfg_file_path_priority(self):
    ...
    def test_613_plugin_loader_gap_coverage(self):
    ...
    def test_614_generate_random_string_charset_and_secrets(self):
    ...
    def test_615_normalize_resolved_ips(self):
    ...
    def test_616_filter_http01_target_ips_permissive(self):
    ...
    def test_617_filter_http01_target_ips_strict(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_618_url_get_dns_pinned_success(self, mock_get):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.requests.get")
    def test_619_url_get_dns_pinned_ipv6_host_and_peer(self, mock_get):
    ...
    def test_620_legacy_acme_get_load_default_false(self):
    ...
    def test_621_legacy_acme_get_load_true_warns(self):
    ...
    def test_622_response_http_code_non_dict(self):
    ...
    def test_623_response_http_code_invalid_code(self):
    ...
    def test_624_log_response_success_with_code_200(self):
    ...
    def test_625_syslog_address_host_port_and_fallbacks(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_626_logger_setup_syslog_empty_address(self, mock_load_cfg, mock_syslog):
    ...
    def test_627_logger_setup_syslog_already_attached(self):
    ...
    def test_628_logger_setup_syslog_oserror(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.logging.FileHandler")
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_629_logger_setup_log_file_empty_path(
        self, mock_load_cfg, mock_file_handler
    ):
    ...
    def test_630_logger_setup_log_file_already_attached(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_631_log_cert_content_enabled_missing_helper_section(
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_632_log_cert_content_enabled_invalid_boolean(self, mock_load_config):
    ...
    def test_633_kerberos_kinit_command_resolve_rejects_null_byte(self):
    ...
    def test_634_tnauthlist_configuration_validate_disabled(self):
    ...
    def test_635_tnauthlist_configuration_validate_enabled_not_acknowledged(self):
    ...
    def test_636_tnauthlist_configuration_validate_enabled_acknowledged(self):
    ...
    def test_637_tnauthlist_configuration_validate_empty_config(self):
    ...
    def test_638_challenge_type_configuration_validate_all_disabled(self):
    ...
    def test_639_challenge_type_configuration_validate_dns_persist_enabled(self):
    ...
    def test_640_challenge_type_configuration_validate_default_enabled(self):
    ...
    def test_641_default_wsgi_dbfile(self):
    ...
    def test_642_default_acme_srv_cfg_file_preferred_deploy(self):
    ...
    def test_643_cert_bound_names_get_empty(self):
    ...
    def test_644_cert_bound_names_get_sans_and_cn(self):
    ...
    def test_645_cert_bound_names_get_malformed_san(self):
    ...
    def test_646_cert_bound_names_get_email_rewrite(self):
    ...
    def test_647_normalize_bound_name_empty_and_invalid_ip(self):
    ...
    def test_648_cn_bound_type_ip(self):
    ...
    def test_649_san_list_to_bound_names(self):
    ...
    def test_650_csr_bound_names_get_malformed_san(self):
    ...
    def test_651_unique_key_loader_duplicate_and_mapping(self):
    ...
    def test_652_set_yaml_option_null_and_new_section(self):
    ...
    def test_653_log_loaded_acme_srv_cfg_flushes_last(self):
    ...
    def test_654_detect_config_format_variants(self):
    ...
    def test_655_yaml_value_and_parse_yaml(self):
    ...
    def test_656_config_allowed_header_values_load(self):
    ...
    def test_657_header_value_allowlist_resolve(self, mock_load_cfg):
