...
-----END CERTIFICATE-----"""
    ...
    @patch("importlib.import_module")
    def test_295_ca_handler_load_default_deprecated(self, mock_imp):
    ...
    def test_296_ca_handler_load(self, mock_util):
        """test ca_handler_load"""
    ...
    @patch("importlib.import_module")
    def test_309_ca_handler_load_module(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_310_eab_handler_load_module(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_311_hooks_load_module(self, mock_imp):
    ...
    @patch("importlib.util")
    def test_312_ca_handler_load_file_deprecated(self, mock_util):
    ...
    @patch("importlib.import_module")
    @patch("importlib.util")
    def test_313_ca_handler_module_preferred_over_file(self, mock_util, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_314_ca_handler_load_info_once(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_315_eab_handler_load_info_once(self, mock_imp):
    ...
    @patch("importlib.import_module")
    def test_316_hooks_load_info_once(self, mock_imp):
    ...
    def test_317_is_filesystem_path(self):
    ...
    @patch("importlib.util")
    def test_318_ca_handler_module_path(self, mock_util):
    ...
    @patch("importlib.import_module")
    def test_319_ca_handler_module_dotted_not_path(self, mock_imp):
    ...
    @patch("importlib.util")
    def test_320_eab_handler_module_path(self, mock_util):
    ...
    @patch("importlib.util")
    def test_321_hooks_module_path(self, mock_util):
    ...
    def test_322_error_dic_get(self):
        """test error_dic_get"""
        result = {
    ...
    def test_328_logger_certificate_modify_pem_content(self):
    ...
    def test_334_config_check(self):
        """test config check"""
    ...
    def test_335_helper_cert_cn_get(self):
        """get cn of csr"""
        cert = """MIIDDTCCAfWgAwIBAgIBCjANBgkqhkiG9w0BAQsFADAaMRgwFgYDVQQDEw9mb28u
                ZXhhbXBsZS5jb20wHhcNMTkwMTIwMTY1OTIwWhcNMTkwMjE5MTY1OTIwWjAaMRgw
                FgYDVQQDEw9mb28uZXhhbXBsZS5jb20wggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAw
    ...
    def test_347_certid_asn1_get(self):
...
-----END CERTIFICATE-----"""
    ...
    def test_348_certid_hex_get(self):
        """test certid_check"""
        certid = "false"
        renewal_info = "MFswCwYJYIZIAWUDBAIBBCDhge--b3rj6nHHj8meQibXGFcVvj0onqpWgB3_RpbKTQQgrg3PUzRWkYJrgdCT6cdYjDXdXsXqz1sbJgYzBRXV-vQCCCzKhfZA1UFC"
        self.assertEqual(
    ...
    def test_364_cert_ski_get(self):
        """test cert_san_get for a multiple SAN of type DNS"""
        cert = """MIIDIzCCAgugAwIBAgICBZgwDQYJKoZIhvcNAQELBQAwGjEYMBYGA1UEAxMPZm9v
                LmV4YW1wbGUuY29tMB4XDTE5MDEyMDE3MDkxMVoXDTE5MDIxOTE3MDkxMVowGjEY
                MBYGA1UEAxMPZm9vLmV4YW1wbGUuY29tMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8A
    ...
    def test_365_cert_aki_get(self):
    ...
    def test_366_cert_aki_get_error_handling(self):
    ...
    def test_367_cert_ski_get_error_handling(self, mock_ext, mock_ski_get):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.header_info_get")
    def test_398_header_info_lookup(self, mock_info, mock_json):
        """test header_info_lookup"""
    ...
    def test_411_eab_profile_as_bool(self):
    ...
    def test_412_eab_profile_list_check(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    def test_414_eab_profile_list_check(self, mock_chk):
        """test _eab_profile_list_check()"""
        cahandler = FakeDBStore()
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    @patch("acme2certifier.acme_srv.helpers.eab.client_parameter_validate")
    def test_416_eab_profile_list_check(self, mock_hifv, mock_chk):
        """test _eab_profile_list_check()"""
        cahandler = FakeDBStore()
        cahandler.foo = "foo"
        cahandler.header_info_field = "header_info_field"
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.allowed_domainlist_check")
    def test_419_eab_profile_list_check(self, mock_chk):
        """test _eab_profile_list_check() test allowed domain check if eabhandler contains attribute"""
        cahandler = FakeDBStore()
        mock_chk.return_value = False
        cahandler.allowed_domainlist = ["foo", "foobar"]
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_422_eab_profile_header_info_check(
        self, mock_lookup, mock_eab, mock_profile
    ):
        """test eab_profile_header_info_check()"""
        cahandler = FakeDBStore()
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_423_eab_profile_header_info_check_skip_handler_routing_name(
        self, mock_lookup, mock_eab, mock_profile
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_426_eab_profile_header_info_check_allowlist(
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_427_eab_profile_header_info_check_risk_gate(
        self, mock_lookup, mock_eab, mock_allowlist
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_428_eab_profile_header_info_check_not_in_allowlist(
        self, mock_lookup, mock_eab, mock_allowlist
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_check")
    @patch("acme2certifier.acme_srv.helpers.eab.header_info_lookup")
    def test_431_eab_profile_header_info_check(self, mock_lookup, mock_eab):
        """test eab_profile_header_info_check()"""
        cahandler = FakeDBStore()
        cahandler.eab_profiling = True
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_433_eab_profile_check(self, mock_string, mock_list):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
        self.handler_hifield = "testField"
        self.cahandler.eab_handler.return_value.__enter__.return_value.eab_profile_get.return_value = {
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_435_eab_profile_check(self, mock_string, mock_list, mock_hil):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
        self.handler_hifield = "testField"
        self.cahandler.eab_handler.return_value.__enter__.return_value.eab_profile_get.return_value = {
    ...
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_list_check")
    @patch("acme2certifier.acme_srv.helpers.eab.eab_profile_string_check")
    def test_437_eab_profile_check(self, mock_string, mock_list, mock_subject):
        self.cahandler = MagicMock()
        self.csr = "testCSR"
    ...
    def test_444_csr_subject_get(self):
        """test csr_subject_get()"""
    ...
    def test_466_enrollment_config_log(self):
    ...
    def test_467_enrollment_config_log_sensitive_name_fragment(self):
    ...
    def test_468_kerberos_kinit_command_resolve_default(self):
    ...
    def test_469_kerberos_kinit_command_resolve_absolute(self):
    ...
    def test_470_kerberos_kinit_command_resolve_debian_alternatives(self):
    ...
    def test_471_kerberos_kinit_command_resolve_rejects_relative(self):
    ...
    def test_472_kerberos_kinit_command_resolve_rejects_wrong_basename(self):
    ...
    def test_473_kerberos_kinit_command_resolve_rejects_bad_symlink_target(self):
    ...
    def test_475_enrollment_config_log(self):
        """test enrollment_config_log()"""
    ...
    def test_483_config_allowed_domainlist_load(self):
        """test config_allowed_domainlist_load()"""
        config_dic = {"CAhandler": {"allowed_domainlist": "foo"}}
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual(
    ...
    def test_484_domainlist_check(self):
    ...
    @patch("idna.encode")
    def test_497_is_domain_whitelisted(self, mock_idna):
        """exception"""
    ...
    def test_500_is_domain_whitelisted(self):
    ...
    @patch("idna.encode")
    def test_501_is_domain_whitelisted(self, mock_idna):
        """exception"""
        list_ = ["example.com", "*.bar.foo"]
        entry = "foo.bar.foo"
    ...
    @patch("acme2certifier.acme_srv.helpers.utils.secrets.randbelow")
    def test_509_radomize_parameter_list(self, mock_rand):
        """test radomize_parameter_list()"""
    ...
    def test_511_config_profile_load(self):
        """test _config_load with unknown values config"""
        parser = configparser.ConfigParser()
    ...
    def test_520_eab_profile_revocation_check_str_value(self, mock_b64_url_recode):
    ...
    def test_521_eab_profile_revocation_check_str_and_ignore_value(
    ...
    def test_522_eab_profile_revocation_check_list_value(self, mock_b64_url_recode):
    ...
    def test_523_eab_profile_revocation_check_list_value_fallback(
        self, mock_b64_url_recode
    ):
    ...
    def test_524_missing_required_keys(self):
    ...
    def test_525_all_required_keys_present(self):
        class DummyHandler(object):
            def __init__(self):
                self.vault_url = "url"
    ...
    def test_526_empty_config(self):
        class DummyHandler(object):
            def __init__(self):
                self.vault_url = "url"
                self.vault_token = "token"
    ...
    def test_527_config_proxy_load_valid_config(self, mock_parse_url, mock_proxy_check):
    ...
    def test_529_config_proxy_load_no_proxy_server_list(self):
    ...
    def test_530_config_proxy_load_invalid_json(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_531_config_proxy_load_no_host_in_url(self, mock_parse_url):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.proxy_check")
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_532_config_proxy_load_proxy_check_returns_none(
    ...
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_533_config_proxy_load_parse_url_exception(self, mock_parse_url):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.proxy_check")
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_534_config_proxy_load_host_without_port(
        self, mock_parse_url, mock_proxy_check
    ):
    ...
    @patch("acme2certifier.acme_srv.helpers.network.proxy_check")
    @patch("acme2certifier.acme_srv.helpers.network.parse_url")
    def test_535_config_proxy_load_empty_proxy_list(
        self, mock_parse_url, mock_proxy_check
    ):
    ...
    def test_536_config_async_mode_load_true_with_django(self):
    ...
    def test_537_config_async_mode_load_true_non_django(self):
    ...
    def test_538_config_async_mode_load_false_with_django(self):
    ...
    def test_539_config_async_mode_load_default_fallback(self):
    ...
    def test_540_config_async_mode_load_no_default_section(self):
        """test config_async_mode_load() with no DEFAULT section"""
        config_dic = configparser.ConfigParser()
        db_type = "django"
        self.assertFalse(self.config_async_mode_load(self.logger, config_dic, db_type))

    def test_541_config_async_mode_load_invalid_boolean(self):
    ...
    def test_542_config_async_mode_load_case_insensitive_true(self):
    ...
    def test_543_config_async_mode_load_case_insensitive_false(self):
    ...
    def test_544_config_async_mode_load_different_db_types(self):
    ...
    def test_545_fqdn_resolve_successful_a_record_no_catch_all(self):
    ...
    def test_546_fqdn_resolve_successful_aaaa_record_no_catch_all(self):
    ...
    def test_547_fqdn_resolve_successful_catch_all_both_records(self):
    ...
    def test_548_fqdn_resolve_nxdomain_error(self):
    ...
    def test_549_fqdn_resolve_no_answer_error(self):
    ...
    def test_550_fqdn_resolve_timeout_error(self):
    ...
    def test_551_fqdn_resolve_generic_error(self):
    ...
    def test_552_fqdn_resolve_mixed_errors_catch_all(self):
    ...
    def test_553_fqdn_resolve_empty_answers_no_catch_all(self):
    ...
    def test_554_fqdn_resolve_empty_answers_catch_all(self):
    ...
    def test_555_fqdn_resolve_partial_success_catch_all(self):
    ...
    def test_556_fqdn_resolve_multiple_a_records_no_catch_all(self):
    ...
    def test_557_fqdn_resolve_a_fails_aaaa_succeeds_no_catch_all(self):
    ...
    def test_558_fqdn_resolve_logging_verification(self):
    ...
    def test_559_ptr_resolve_successful_resolution(self):
    ...
    def test_560_ptr_resolve_successful_with_dns_servers(self):
    ...
    def test_561_ptr_resolve_exception_handling(self):
    ...
    def test_562_ptr_resolve_nxdomain_error(self):
    ...
    def test_563_ptr_resolve_timeout_error(self):
    ...
    def test_564_ptr_resolve_invalid_address_format(self):
    ...
    def test_565_ptr_resolve_empty_response(self):
    ...
    def test_566_ptr_resolve_logging_verification(self):
    ...
    def test_567_ptr_resolve_error_logging_verification(self):
    ...
    def test_568_ptr_resolve_ipv6_address(self):
    ...
    def test_569_url_get_with_default_dns_successful_200(self):
    ...
    def test_570_url_get_with_default_dns_successful_non_200(self):
    ...
    def test_571_url_get_with_default_dns_exception_fallback_success(self):
    ...
    def test_572_url_get_with_default_dns_fallback_read_timeout(self):
    ...
    def test_573_url_get_with_default_dns_fallback_connection_error(self):
    ...
    def test_574_url_get_with_default_dns_fallback_generic_exception(self):
    ...
    def test_575_url_get_with_default_dns_fallback_non_200(self):
    ...
    def test_576_url_get_with_default_dns_with_proxy_config(self):
    ...
    def test_577_url_get_with_default_dns_logging_verification(self):
    ...
    def test_578_allowed_gai_family(self):
    ...
    def test_579_config_allowed_domainlist_load_deprecated_section(self):
    ...
    def test_580_config_allowed_domainlist_load_invalid_json(self):
    ...
    def test_586_pkcs7_to_pem_tag_replacement_logs_error(self):
    ...
    def test_587_pkcs7_to_pem_all_strategies_fail(self):
    ...
    def test_589_config_dryrun_load_not_set(self):
    ...
    def test_590_config_dryrun_load_true(self):
        """Test config_dryrun_load with valid 'true' value."""
        config_dic = configparser.ConfigParser()
    ...
    def test_591_config_dryrun_load_false(self):
    ...
    def test_592_config_dryrun_load_profile(self):
    ...
    def test_593_config_dryrun_load_profile_no_profilename(self):
    ...
    def test_597_is_ip_whitelisted_invalid(self):
        """Test is_ip_whitelisted with invalid IP list."""
        self.assertFalse(
            self.is_ip_whitelisted(
                self.logger,
    ...
    def test_598_is_ip_whitelisted_no_match(self):
    ...
    def test_599_is_ip_whitelisted_exact_match(self):
    ...
    def test_600_is_ip_whitelisted_cidr_match(self):
    ...
    def test_601_is_ip_whitelisted_cidr_32match(self):
    ...
    def test_602_is_ip_whitelisted_invalid_network(self):
    ...
    def test_605_config_allowed_iplist_load(self):
        """test config_allowed_iplist_load()"""
        config_dic = {"Order": {"allowed_iplist": "foo"}}
        with self.assertLogs("test_a2c", level="INFO") as lcm:
            self.assertEqual(
    ...
    def test_606_is_email_whitelisted_exact_match(self):
    ...
    def test_607_is_email_whitelisted_case_insensitive(self):
    ...
    def test_608_is_email_whitelisted_not_in_list(self):
        """Test is_email_whitelisted returns False for non-matching email"""
        from acme2certifier.acme_srv.helpers.domain_utils import is_email_whitelisted

        email_list = ["user@example.com", "admin@domain.com"]

    def test_609_is_email_whitelisted_with_whitespace(self):
    ...
    def test_610_email_whitelisted_empty_list(self):
    ...
    def test_611_is_email_whitelisted_exact_match(self):
    ...
    def test_612_is_email_whitelisted_wildcard(self):
    ...
    def test_613_is_email_whitelisted_mixed_patterns(self):
    ...
    def test_614_is_email_whitelisted_strip_and_case(self):
    ...
    def test_615_cert_aki_asn1_get_success_and_missing(self):
    ...
    def test_616_cert_ski_asn1_get_success_and_missing(self):
    ...
    def test_617_cert_aki_asn1_get_missing_key_identifier(self):
    ...
    def test_618_cert_extension_raw_get_no_extensions(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.certificates.x509.Certificate.extensions")
    def test_619_cert_aki_get_falls_back_to_asn1(self, mock_ext, mock_aki_get):
    ...
    def test_620_default_deploy_base_dir_and_resolve_config_path(self):
    ...
    def test_621_warn_acme_srv_cfg_path_once(self):
    ...
    def test_622_default_acme_srv_cfg_file_path_priority(self):
    ...
    def test_623_plugin_loader_gap_coverage(self):
    ...
    def test_624_generate_random_string_charset_and_secrets(self):
    ...
    def test_625_normalize_resolved_ips(self):
    ...
    def test_626_filter_http01_target_ips_permissive(self):
    ...
    def test_627_filter_http01_target_ips_strict(self):
    ...
    def test_631_legacy_acme_get_load_true_warns(self):
    ...
    def test_632_response_http_code_non_dict(self):
    ...
    def test_633_response_http_code_invalid_code(self):
    ...
    def test_634_log_response_success_with_code_200(self):
    ...
    def test_635_syslog_address_host_port_and_fallbacks(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_636_logger_setup_syslog_empty_address(self, mock_load_cfg, mock_syslog):
    ...
    def test_637_logger_setup_syslog_already_attached(self):
    ...
    def test_638_logger_setup_syslog_oserror(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.logging.FileHandler")
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_639_logger_setup_log_file_empty_path(
        self, mock_load_cfg, mock_file_handler
    ):
    ...
    def test_640_logger_setup_log_file_already_attached(self):
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_641_log_cert_content_enabled_missing_helper_section(
    ...
    @patch("acme2certifier.acme_srv.helpers.logging_utils.load_config")
    def test_642_log_cert_content_enabled_invalid_boolean(self, mock_load_config):
    ...
    def test_643_kerberos_kinit_command_resolve_rejects_null_byte(self):
    ...
    def test_644_tnauthlist_configuration_validate_disabled(self):
    ...
    def test_645_tnauthlist_configuration_validate_enabled_not_acknowledged(self):
    ...
    def test_646_tnauthlist_configuration_validate_enabled_acknowledged(self):
    ...
    def test_647_tnauthlist_configuration_validate_empty_config(self):
    ...
    def test_648_challenge_type_configuration_validate_all_disabled(self):
    ...
    def test_649_challenge_type_configuration_validate_dns_persist_enabled(self):
    ...
    def test_650_challenge_type_configuration_validate_default_enabled(self):
    ...
    def test_651_default_wsgi_dbfile(self):
    ...
    def test_652_default_acme_srv_cfg_file_preferred_deploy(self):
    ...
    def test_653_cert_bound_names_get_empty(self):
    ...
    def test_654_cert_bound_names_get_sans_and_cn(self):
    ...
    def test_655_cert_bound_names_get_malformed_san(self):
    ...
    def test_656_cert_bound_names_get_email_rewrite(self):
    ...
    def test_657_normalize_bound_name_empty_and_invalid_ip(self):
    ...
    def test_658_cn_bound_type_ip(self):
    ...
    def test_659_san_list_to_bound_names(self):
    ...
    def test_660_csr_bound_names_get_malformed_san(self):
    ...
    def test_661_unique_key_loader_duplicate_and_mapping(self):
    ...
    def test_662_set_yaml_option_null_and_new_section(self):
    ...
    def test_663_log_loaded_acme_srv_cfg_flushes_last(self):
    ...
    def test_664_detect_config_format_variants(self):
    ...
    def test_665_yaml_value_and_parse_yaml(self):
    ...
    def test_666_config_allowed_header_values_load(self):
    ...
    def test_667_header_value_allowlist_resolve(self, mock_load_cfg):
    ...
    def test_668_challenge_type_configuration_validate_empty_config(self):
    ...
    def test_669_normalize_email_address_empty_local_or_domain(self):
    ...
    def test_670_normalize_email_address_idna_error(self):
    ...
    def test_671_eab_profile_check_skips_cahandler_name(self):
    ...
    def test_672_eab_profile_string_check_skips_cahandler_name(self):
    ...
    def test_673_cahandler_section_merged_config_passthrough(self):
    ...
    def test_674_cahandler_section_merged_config_missing_section(self):
    ...
    def test_675_cahandler_section_merged_config_no_base_section(self):
    ...
    def test_676_cahandler_section_merged_config_defensive_copy(self):
    ...
    def test_677_resolve_config_injected_and_load(self):
    ...
    def test_678_load_config_cache_hit_without_logger(self):
    ...
    def test_679_load_config_section_default_cahandler(self):
    ...
    def test_680_load_cahandler_config_from_handler_attrs(self):
    ...
    def test_681_cahandler_lookup_no_input(self):
    ...
    def test_682_cahandler_lookup_db_error(self):
    ...
    def test_683_load_from_file_spec_none(self):
    ...
    def test_684_loaded_identity_partial(self):
    ...
    def test_685_section_flag_true_missing_and_invalid(self):
    ...
    def test_686_ca_handler_load_from_section_missing(self):
    ...
    def test_687_ca_handler_load_from_section_no_fallback(self):
    ...
    def test_688_config_debug_get_cfg_overrides_env(self):
    ...
    def test_689_logger_setup_false_filters_load_config_debug(self):
    ...
    def test_690_apply_log_levels_and_dict_debug_invalid(self):
