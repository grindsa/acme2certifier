...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_004_allowed_domainlist_check(self, mock_adc):
    ...
    @patch('examples.ca_handler.digicert_ca_handler.allowed_domainlist_check')
    def test_005_allowed_domainlist_check(self, mock_adc):
        """ test allowed_domainlist_check """
    ...
    @patch('requests.put')
    def test_020__api_put(self, mock_req):
        """ test _api_put() """
        mockresponse = Mock()
        mockresponse.status_code = 'status_code'
        mockresponse.text = None
    ...
    @patch('requests.put')
    def test_021__api_put(self, mock_req):
        """ test _api_put() """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    @patch('examples.ca_handler.digicert_ca_handler.config_eab_profile_load')
    @patch('examples.ca_handler.digicert_ca_handler.load_config')
    def test_035_config_load(self, mock_load, mock_eab, mock_hdl):
        """ test _config_load() """
        mock_load.return_value = {'foo': 'bar', 'CAhandler': {'allowed_domainlist': "foo"}}
        mock_eab.return_value = True, 'eab'
        mock_hdl.return_value = 'hdl'
    ...
    def test_038_order_response_parse(self, mock_b64, mock_pem2der):
        """ test _order_parse() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.cert_pem2der')
    @patch('examples.ca_handler.digicert_ca_handler.b64_encode')
    def test_039_order_response_parse(self, mock_b64, mock_pem2der):
        """ test _order_parse() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.cert_pem2der')
    @patch('examples.ca_handler.digicert_ca_handler.b64_encode')
    def test_040_order_response_parse(self, mock_b64, mock_pem2der):
        """ test _order_parse() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.cert_pem2der')
    @patch('examples.ca_handler.digicert_ca_handler.b64_encode')
    def test_041_order_response_parse(self, mock_b64, mock_pem2der):
        """ test _order_parse() """
    ...
    def test_042_organiation_id_get(self, mock_get):
    ...
    @patch('examples.ca_handler.digicert_ca_handler.CAhandler._api_get')
    def test_043_organiation_id_get(self, mock_get):
        """ test _organiation_id_get() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.CAhandler._api_get')
    def test_044_organiation_id_get(self, mock_get):
        """ test _organiation_id_get() """
        mock_get.return_value = (200, {'organizations': [{'name': 'name1', 'id': 'id1'}, {'name': 'name2', 'id': 'id2'}, {'name': 'name3', 'id': 'id3'}]})
    ...
    def test_045_csr_check(self, mock_dlchk, mock_ehichk):
        """ test _csr_check() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.eab_profile_header_info_check')
    @patch('examples.ca_handler.digicert_ca_handler.CAhandler._allowed_domainlist_check')
    def test_046_csr_check(self, mock_dlchk, mock_ehichk):
        """ test _csr_check() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.eab_profile_header_info_check')
    @patch('examples.ca_handler.digicert_ca_handler.CAhandler._allowed_domainlist_check')
    def test_047_csr_check(self, mock_dlchk, mock_ehichk):
        """ test _csr_check() """
        mock_dlchk.return_value = False
    ...
    def test_053_revoke(self, mock_serial, mock_put):
        """ test revoke() """
    ...
    @patch('examples.ca_handler.digicert_ca_handler.CAhandler._api_put')
    @patch('examples.ca_handler.digicert_ca_handler.cert_serial_get')
    def test_054_revoke(self, mock_serial, mock_put):
        """ test revoke() """
