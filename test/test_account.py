...
class TestACMEHandler(unittest.TestCase):
    ...
    @patch('acme_srv.message.Message.check')
    def test_032_account_parse(self, mock_mcheck, mock_contact_upd):
    ...
    @patch('acme_srv.account.Account._contacts_update')
    @patch('acme_srv.message.Message.check')
    def test_033_account_parse(self, mock_mcheck, mock_contact_upd, mock_account_lookup, mock_nnonce, mock_info):
    ...
    @patch('acme_srv.account.Account._lookup')
    @patch('acme_srv.message.Message.check')
    def test_034_account_parse(self, mock_mcheck, mock_account_lookup, mock_nnonce, mock_info):
    ...
    @patch('acme_srv.account.Account._lookup')
    @patch('acme_srv.message.Message.check')
    def test_035_account_parse(self, mock_mcheck, mock_account_lookup, mock_nnonce, mock_info):
        """ test succ account parse for request for account info """
        mock_mcheck.return_value = (200, None, None, 'protected', {}, 'account_name')
        mock_nnonce.return_value = 'new_nonce'
    ...
    def test_036_account__onlyreturnexisting(self):
    ...
    def test_037_account__onlyreturnexisting(self):
    ...
    @patch('acme_srv.account.Account._contact_check')
    def test_041_account__contacts_update(self, mock_contact_chk,):
    ...
    @patch('acme_srv.account.Account._contact_check')
    def test_042_account__contacts_update(self, mock_contact_chk,):
    ...
    def test_061_account__inner_payload_check(self):
    ...
    def test_062_account__inner_payload_check(self):
    ...
    def test_065_account__inner_payload_check(self, mock_cmp):
        """ Account.inner_payload_check() with same kid and account values but no old_key"""
        outer_protected = {'kid': 'kid'}
    ...
    def test_066_account__key_change_validate(self):
    ...
    @patch('acme_srv.account.Account._lookup')
    def test_067_account__key_change_validate(self, mock_lup):
    ...
    @patch('acme_srv.account.Account._lookup')
    def test_068_account__key_change_validate(self, mock_lup, mock_jws_chk):
    ...
    @patch('acme_srv.account.Account._inner_jws_check')
    @patch('acme_srv.account.Account._lookup')
    def test_069_account__key_change_validate(self, mock_lup, mock_jws_chk, mock_pl_chk):
    ...
    def test_070_account__key_change(self):
    ...
    def test_071_account__key_change(self):
    ...
    @patch('acme_srv.message.Message.check')
    def test_072_account__key_change(self, mock_mcheck):
    ...
    @patch('acme_srv.message.Message.check')
    def test_073_account__key_change(self, mock_mcheck, moch_kchval):
        """ Account.key_change() with URL in protected without key-change in url"""
        protected = {'url': 'url/key-change'}
    ...
    @patch('acme_srv.account.Account._key_change_validate')
    @patch('acme_srv.message.Message.check')
    def test_074_account__key_change(self, mock_mcheck, moch_kchval):
    ...
    @patch('acme_srv.account.generate_random_string')
    def test_076_account__add(self, mock_name):
    ...
    @patch('acme_srv.account.generate_random_string')
    def test_077_account__add(self, mock_name):
        """ test successful account add for a new account"""
        self.account.dbstore.account_add.return_value = (2, True)
        self.account.ecc_only = True
        mock_name.return_value = 'randowm_string'
    ...
    @patch('acme_srv.account.generate_random_string')
    def test_079__account__add(self, mock_name):
    ...
    @patch('acme_srv.account.generate_random_string')
    def test_080__account__add(self, mock_name):
    ...
    @patch('acme_srv.account.generate_random_string')
    def test_081__account__add(self, mock_name, mock_eabkid):
    ...
    @patch('acme_srv.message.Message.check')
    def test_082_account_new(self, mock_mcheck):
    ...
    @patch('acme_srv.account.Account._contact_check')
    @patch('acme_srv.message.Message.check')
    def test_083_account_new(self, mock_mcheck, mock_contact, mock_aad, mock_nnonce):
    ...
    @patch('acme_srv.account.Account._contact_check')
    @patch('acme_srv.message.Message.check')
    def test_084_account_new(self, mock_mcheck, mock_contact, mock_aad, mock_nnonce):
    ...
    @patch('acme_srv.account.Account._add')
    @patch('acme_srv.message.Message.check')
    def test_085_account_new(self, mock_mcheck, mock_aad, mock_nnonce):
    ...
    @patch('acme_srv.account.Account._add')
    @patch('acme_srv.message.Message.check')
    def test_086_account_new(self, mock_mcheck, mock_aad, mock_nnonce, mock_tos):
    ...
    @patch('acme_srv.account.Account._add')
    @patch('acme_srv.message.Message.check')
    def test_087_account_new(self, mock_mcheck, mock_aad, mock_nnonce, mock_tos, mock_eab):
    ...
    @patch('acme_srv.account.Account._add')
    @patch('acme_srv.message.Message.check')
    def test_088_account_new(self, mock_mcheck, mock_aad, mock_nnonce, mock_tos, mock_eab):
    ...
    @patch('acme_srv.message.Message.check')
    def test_089_account_new(self, mock_mcheck):
    ...
    def test_090_account__lookup(self):
    ...
    def test_091_account__onlyreturnexisting(self):
    ...
    def test_092_account__key_compare(self):
    ...
    @patch('acme_srv.account.Account._key_change_validate')
    @patch('acme_srv.message.Message.check')
    def test_093_account__key_change(self, mock_mcheck, moch_kchval):
    ...
    def test_094_account__delete(self):
    ...
    def test_095_account__delete(self):
    ...
    @patch('acme_srv.account.Account._contact_check')
    def test_096_account__contacts_update(self, mock_contact_chk,):
    ...
    @patch('acme_srv.account.generate_random_string')
    def test_097_account__add(self, mock_name):
    ...
    def test_105_eab_check(self, mock_cmp):
        """ test external account binding False """
    ...
    @patch('acme_srv.account.Account._eab_kid_get')
    @patch('acme_srv.account.Account._eab_jwk_compare')
    def test_106_eab_check(self, mock_cmp, mock_kget):
    ...
    @patch('acme_srv.account.Account._eab_kid_get')
    @patch('acme_srv.account.Account._eab_jwk_compare')
    def test_107_eab_check(self, mock_cmp, mock_kget):
    ...
    @patch('acme_srv.account.Account._eab_kid_get')
    @patch('acme_srv.account.Account._eab_jwk_compare')
    def test_108_eab_check(self, mock_cmp, mock_kget, mock_sigvrf):
    ...
    @patch('acme_srv.account.Account._eab_kid_get')
    @patch('acme_srv.account.Account._eab_jwk_compare')
    def test_109_eab_check(self, mock_cmp, mock_kget, mock_sigvrf):
        """ test external _eab_kid_get returns value but mac lookup successful sig verification failed"""
        payload = {'externalaccountbinding': {'payload': 'payload', 'protected': 'protected'}}
        protected = 'protected'
        mock_cmp.return_value = True
    ...
    @patch('acme_srv.account.load_config')
    def test_121_config_load(self, mock_load_cfg, mock_imp):
        """ test _config_load account with contact_check_disable True """
        parser = configparser.ConfigParser()
        parser['EABhandler'] = {'foo': 'bar', 'eab_handler_file': 'foo'}
        mock_load_cfg.return_value = parser
    ...
    def test_137__eab_signature_verify(self, mock_eabchk):
    ...
    @patch('acme_srv.signature.Signature.eab_check')
    def test_138__eab_signature_verify(self, mock_eabchk):
    ...
    def test_140__enter__(self, mock_cfg):
        """ test enter """
    ...
    def test_141__info_(self, mock_date):
    ...
    @patch('acme_srv.account.date_to_datestr')
    def test_142__info_(self, mock_date):
