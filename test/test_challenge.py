...
class TestACMEHandler(unittest.TestCase):
    ...
    @patch('acme_srv.challenge.Challenge._name_get')
    @patch('acme_srv.message.Message.check')
    def test_019_challenge_parse(self, mock_mcheck, mock_cname, mock_info, mock_tnauth, mock_nnonce):
    ...
    @patch('acme_srv.challenge.Challenge._name_get')
    @patch('acme_srv.message.Message.check')
    def test_021_challenge_parse(self, mock_mcheck, mock_cname, mock_cinfo, mock_tnauth, mock_nnonce):
    ...
    @patch('acme_srv.challenge.Challenge._name_get')
    @patch('acme_srv.message.Message.check')
    def test_022_challenge_parse(self, mock_mcheck, mock_cname, mock_cinfo, mock_tnauth, mock_nnonce):
    ...
    @patch('acme_srv.challenge.Challenge._name_get')
    @patch('acme_srv.message.Message.check')
    def test_023_challenge_parse(self, mock_mcheck, mock_cname, mock_cinfo, mock_tnauth, mock_nnonce, mock_validate):
    ...
    @patch('acme_srv.challenge.fqdn_resolve')
    @patch('acme_srv.challenge.url_get')
    def test_032_challenge__validate_http_challenge(self, mock_url, mock_resolve, mock_proxy):
        """ test Chalölenge.validate_http_challenge() with a correct challenge """
        mock_url.return_value = 'token.jwk_thumbprint'
    ...
    @patch('acme_srv.challenge.b64_url_encode')
    @patch('acme_srv.challenge.txt_get')
    def test_040_challenge__validate_dns_challenge(self, mock_dns, mock_code, mock_hash, mock_resolve):
    ...
    @patch('acme_srv.challenge.b64_url_encode')
    @patch('acme_srv.challenge.txt_get')
    def test_041_challenge__validate_dns_challenge(self, mock_dns, mock_code, mock_hash, mock_resolve):
    ...
    @patch('acme_srv.challenge.servercert_get')
    @patch('acme_srv.challenge.fqdn_resolve')
    def test_081_challenge__validate_alpn_challenge(self, mock_resolve, mock_srv, mock_proxy):
        """ test validate_alpn_challenge no certificate returned """
        mock_resolve.return_value = ('foo', False)
        mock_srv.return_value = None
    ...
    @patch('acme_srv.challenge.servercert_get')
    @patch('acme_srv.challenge.fqdn_resolve')
    def test_082_challenge__validate_alpn_challenge(self, mock_resolve, mock_srv, mock_sanget, mock_sanchk):
    ...
    @patch('acme_srv.challenge.servercert_get')
    @patch('acme_srv.challenge.fqdn_resolve')
    def test_085_challenge__validate_alpn_challenge(self, mock_resolve, mock_srv, mock_sanget, mock_sanchk, mock_encode, mock_ext):
        """ test validate_alpn_challenge extension sucessful """
        mock_resolve.return_value = ('foo', False)
        mock_sanget.return_value = ['foo', 'bar']
        mock_sanchk.return_value = True
    ...
    @patch('acme_srv.challenge.servercert_get')
    @patch('acme_srv.challenge.fqdn_resolve')
    def test_086_challenge__validate_alpn_challenge(self, mock_resolve, mock_srv, mock_sanget, mock_sanchk, mock_encode, mock_ext):
    ...
    @patch('acme_srv.challenge.servercert_get')
    @patch('acme_srv.challenge.fqdn_resolve')
    def test_087_challenge__validate_alpn_challenge(self, mock_resolve, mock_srv, mock_sanget, mock_sanchk, mock_encode, mock_ext):
    ...
    @patch('acme_srv.challenge.servercert_get')
    @patch('acme_srv.challenge.fqdn_resolve')
    def test_088_challenge__validate_alpn_challenge(self, mock_resolve, mock_srv, mock_sanget, mock_sanchk, mock_encode, mock_ext):
        """ test validate_alpn_challenge extension sucessful """
        mock_encode.return_value = 'foo'
