...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_023__api_post(self, mock_req):
    ...
    @patch('requests.post')
    def test_024__api_post(self, mock_post):
        """ CAhandler.get_ca() returns an http error """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    def test_025__ca_get(self, mock_req):
    ...
    @patch.object(requests, 'get')
    def test_027__ca_get(self, mock_req):
    ...
    @patch('requests.get')
    def test_028__api_post(self, mock_get):
        """ CAhandler.get_ca() returns an http error """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get')
    def test_031__ca_get_properties(self, mock_caget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get')
    def test_032__ca_get_properties(self, mock_caget):
        """ CAhandler._ca_get_properties() ca_get returns empty ca_list """
        mock_caget.return_value = {'cas': None}
        self.assertEqual({'status': 404, 'message': 'CA could not be found', 'statusMessage': 'Not Found'}, self.cahandler._ca_get_properties('filterkey', 'filtervalue'))

    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get')
    def test_033__ca_get_properties(self, mock_caget):
    ...
    def test_037__cert_get(self, mock_caget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_038__cert_get(self, mock_caget, mock_post):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._api_post')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_039__cert_get(self, mock_caget, mock_post):
    ...
    @patch('requests.get')
    def test_040__cert_get_properties(self, mock_req):
    ...
    @patch('requests.get')
    def test_041__cert_get_properties(self, mock_get):
        """ CAhandler._cert_get_properties() all good """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    @patch('requests.get')
    def test_046__loop_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_047__loop_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_048__loop_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_049__loop_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_050__loop_poll(self, mock_get, mock_chain):
        """ CAhandler._loop_poll() - status "accepted" returned from  request "certifiate" in but no "certificateBase64" in 2dn request """
        self.cahandler.polling_timeout = 6
        self.cahandler.timeout = 0
        request_url = 'request_url'
    ...
    def test_051_enroll(self, mock_certget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_052_enroll(self, mock_certget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_053_enroll(self, mock_certget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_054_enroll(self, mock_certget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._pem_cert_chain_generate')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_055_enroll(self, mock_certget, mock_chain):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_056_enroll(self, mock_certget, mock_loop):
        """ CAhandler.enroll() _cert_get returns certb64 """
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_057_revoke(self, mock_getca):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_058_revoke(self, mock_getca):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_059_revoke(self, mock_getca, mock_serial):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_060_revoke(self, mock_getca, mock_serial, mock_getcert):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_061_revoke(self, mock_getca, mock_serial, mock_getcert):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_062_revoke(self, mock_getca, mock_serial, mock_getcert):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_063_revoke(self, mock_getca, mock_serial, mock_getcert):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_064_revoke(self, mock_getca, mock_serial, mock_getcert, mock_post):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_065_revoke(self, mock_getca, mock_serial, mock_getcert, mock_post):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_066_revoke(self, mock_getca, mock_serial, mock_getcert, mock_post):
    ...
    def test_068_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_069_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_070_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial, mock_certprop):
        """ CAhandler.trigger() - payload serial number lookup failed"""
        payload = 'foo'
        mock_b64dec.return_value = 'foodecode'
        mock_serial.return_value = 123
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_071_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial, mock_certprop, mock_chain):
        """ CAhandler.trigger() - payload serial number lookup failed"""
        payload = 'foo'
        mock_b64dec.return_value = 'foodecode'
        mock_serial.return_value = 123
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_072_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial, mock_certprop, mock_chain):
        """ CAhandler.trigger() - payload serial number lookup failed"""
        payload = 'foo'
        mock_b64dec.return_value = 'foodecode'
        mock_serial.return_value = 123
    ...
    @patch('requests.get')
    def test_076__pem_cert_chain_generate(self, mock_get):
    ...
    @patch('requests.get')
    def test_077__pem_cert_chain_generate(self, mock_get):
    ...
    @patch('requests.get')
    def test_078__pem_cert_chain_generate(self, mock_get):
    ...
    @patch('requests.get')
    def test_079__pem_cert_chain_generate(self, mock_get):
    ...
    @patch('requests.get')
    def test_080__pem_cert_chain_generate(self, mock_get):
    ...
    def test_082__enter__(self):
        """ test __enter__ """
        self.cahandler.__enter__()

    @patch('requests.get')
    def test_083_request_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_084_request_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_085_request_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_086_request_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_087_request_poll(self, mock_get):
        """ test request poll request returned status accepted but no certinformation in """
        mockresponse = Mock()
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._pem_cert_chain_generate')
    @patch('requests.get')
    def test_088_request_poll(self, mock_get, mock_pemgen):
        """ test request poll request returned status accepted but no certinformation in """
        mockresponse = Mock()
