...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_026__api_post(self, mock_req):
    ...
    @patch('requests.post')
    def test_027__api_post(self, mock_post):
        """ CAhandler.get_ca() returns an http error """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    def test_028__ca_get(self, mock_req):
    ...
    @patch('requests.get')
    def test_031__api_post(self, mock_get):
        """ CAhandler.get_ca() returns an http error """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    def test_040__cert_get(self, mock_caget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_041__cert_get(self, mock_caget, mock_post):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._api_post')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_042__cert_get(self, mock_caget, mock_post):
    ...
    @patch('requests.get')
    def test_043__cert_get_properties(self, mock_req):
    ...
    @patch('requests.get')
    def test_044__cert_get_properties(self, mock_get):
        """ CAhandler._cert_get_properties() all good """
        self.cahandler.api_host = 'api_host'
        self.cahandler.auth = 'auth'
    ...
    def test_046_poll(self, mock_poll):
        """ CAhandler.poll() poll_identifier is none """
    ...
    @patch('requests.get')
    def test_050__loop_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_051__loop_poll(self, mock_get):
    ...
    @patch('requests.get')
    def test_053__loop_poll(self, mock_get, mock_chain):
        """ CAhandler._loop_poll() - status "accepted" returned from  request "certifiate" in but no "certificateBase64" in 2dn request """
        self.cahandler.polling_timeout = 6
        self.cahandler.timeout = 0
        request_url = 'request_url'
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_055_enroll(self, mock_certget):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._pem_cert_chain_generate')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_058_enroll(self, mock_certget, mock_chain):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._cert_get')
    def test_059_enroll(self, mock_certget, mock_loop):
        """ CAhandler.enroll() _cert_get returns certb64 """
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_060_revoke(self, mock_getca):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_061_revoke(self, mock_getca):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_062_revoke(self, mock_getca, mock_serial):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_064_revoke(self, mock_getca, mock_serial, mock_getcert):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_067_revoke(self, mock_getca, mock_serial, mock_getcert, mock_post):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.cert_serial_get')
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._ca_get_properties')
    def test_068_revoke(self, mock_getca, mock_serial, mock_getcert, mock_post):
    ...
    def test_071_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_072_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial):
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_073_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial, mock_certprop):
        """ CAhandler.trigger() - payload serial number lookup failed"""
        payload = 'foo'
        mock_b64dec.return_value = 'foodecode'
        mock_serial.return_value = 123
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_074_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial, mock_certprop, mock_chain):
        """ CAhandler.trigger() - payload serial number lookup failed"""
        payload = 'foo'
        mock_b64dec.return_value = 'foodecode'
        mock_serial.return_value = 123
    ...
    @patch('examples.ca_handler.certifier_ca_handler.b64_decode')
    @patch('examples.ca_handler.certifier_ca_handler.b64_encode')
    def test_075_trigger(self, mock_b64dec, mock_b64enc, mock_p2d, mock_caprop, mock_serial, mock_certprop, mock_chain):
        """ CAhandler.trigger() - payload serial number lookup failed"""
        payload = 'foo'
        mock_b64dec.return_value = 'foodecode'
        mock_serial.return_value = 123
    ...
    @patch('examples.ca_handler.certifier_ca_handler.CAhandler._pem_cert_chain_generate')
    @patch('requests.get')
    def test_091_request_poll(self, mock_get, mock_pemgen):
        """ test request poll request returned status accepted but no certinformation in """
        mockresponse = Mock()
