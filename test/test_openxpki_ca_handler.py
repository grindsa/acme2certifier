...
class TestACMEHandler(unittest.TestCase):
    ...
    #@patch('requests_pkcs12.Pkcs12Adapter')
    #@patch('examples.ca_handler.openxpki_ca_handler.CAhandler._config_passphrase_load')
    #def test_023__config_session_load(self, mock_pass, mock_req):
    #    """ test _config_server_load() """
    #    config_dic = {'CAhandler': {'client_cert': 'client_cert', 'cert_passphrase': 'cert_passphrase'}}
    #    self.cahandler.session = Mock()
    #    self.cahandler.session.mount = Mock()
    #    self.cahandler.cert_passphrase = 'cert_passphrase'
    #    self.cahandler._config_session_load(config_dic)
    #    self.assertTrue(mock_pass.called)

    def test_024__config_passphrase_load(self):
    ...
    def test_029_config_load(self, mock_load_cfg, mock_auth_load, mock_server_load):
        """ load config """
    ...
    def test_035__rpc_post(self, mock_req):
    ...
    @patch('requests.post')
    def test_036__rpc_post(self, mock_post):
    ...
    def test_037_enroll(self, mock_recode, mock_pem, mock_enroll):
        """ test ernoll """
        csr = 'csr'
        with self.assertLogs('test_a2c', level='INFO') as lcm:
    ...
    def test_040__enroll(self, mock_post, mock_create):
        """ test _enroll() """
    ...
    @patch('examples.ca_handler.openxpki_ca_handler.CAhandler._cert_bundle_create')
    @patch('examples.ca_handler.openxpki_ca_handler.CAhandler._rpc_post')
    def test_044__enroll(self, mock_post, mock_create, mock_sleep):
        """ test _enroll() """
    ...
    def test_045__cert_identifier_get(self):
        """ test _cert_identifier_get() """
        self.assertFalse(self.cahandler._cert_identifier_get(None))

    @patch('examples.ca_handler.openxpki_ca_handler.CAhandler._rpc_post')
    def test_046__cert_identifier_get(self, mock_post):
        """ test _cert_identifier_get() """
        self.cahandler.endpoint_name = 'endpoint_name'
    ...
    @patch('examples.ca_handler.openxpki_ca_handler.CAhandler._rpc_post')
    def test_050__revoke(self, mock_post):
        """ test _revoke() """
    ...
    def test_053_revoke(self, mock_cn, mock_certid, mock_revoke):
        """  test revoke """
