...
class TestACMEHandler(unittest.TestCase):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch('requests.get')
    def test_022__cacerts_get(self, mock_req, mock_to_pem, _mock_b64):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch('requests.post')
    def test_024__simpleenroll(self, mock_req, mock_to_pem, _mock_b64):
        """ test _cacerts_get() successful run """
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch('requests.post')
    def test_025__simpleenroll(self, mock_req, mock_to_pem, _mock_b64):
        """ test _cacerts_get() successful run """
        mock_req.side_effect = Exception('exc_simple_enroll')
        mock_to_pem.return_value = 'pem'
        self.cahandler.est_host = 'foo'
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._cacerts_get')
    def test_027_enroll(self, mock_ca):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._cacerts_get')
    def test_028_enroll(self, mock_ca):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._simpleenroll')
    @patch('examples.ca_handler.est_ca_handler.CAhandler._cacerts_get')
    def test_033_enroll(self, mock_ca, mock_enroll):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._simpleenroll')
    @patch('examples.ca_handler.est_ca_handler.CAhandler._cacerts_get')
    def test_034_enroll(self, mock_ca, mock_enroll):
    ...
    def test_037_get_certificates(self):
    ...
    def test_038__pkcs7_to_pem(self):
    ...
    def test_039__pkcs7_to_pem(self):
    ...
    def test_040__pkcs7_to_pem(self):
    ...
    def test_041__pkcs7_to_pem(self):
        """ test pkcs7 to pem output list """
        with open(self.dir_path + '/ca/certs.p7b', 'r') as fso:
            file_content = fso.read()
        result = None
    ...
    def test_042__pkcs7_to_pem(self, mock_load):
        """ test pkcs7 to pem output list """
        with open(self.dir_path + '/ca/certs.p7b', 'r') as fso:
            file_content = fso.read()
    ...
    def test_043__pkcs7_to_pem(self, mock_load):
        """ test pkcs7 to pem output list """
        with open(self.dir_path + '/ca/certs.p7b', 'r') as fso:
            file_content = fso.read()
        response = Mock()
