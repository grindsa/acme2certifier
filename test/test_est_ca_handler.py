...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_028__cacerts_get(self, mock_req, mock_to_pem, _mock_b64):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch.object(requests, 'get')
    def test_029__cacerts_get(self, mock_req, mock_to_pem, _mock_b64):
        """ test _cacerts_get() successful run by using client certs """
        mockresponse = Mock()
        mock_req.return_value = mockresponse
        mockresponse.text = 'mock return'
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch.object(requests, 'get')
    def test_030__cacerts_get(self, mock_req, mock_to_pem, _mock_b64):
    ...
    def test_032__simpleenroll(self, mock_req, mock_to_pem, _mock_b64):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch('requests.post')
    def test_033__simpleenroll(self, mock_req, mock_to_pem, _mock_b64):
        """ test _cacerts_get() successful run """
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._pkcs7_to_pem')
    @patch('requests.post')
    def test_034__simpleenroll(self, mock_req, mock_to_pem, _mock_b64):
        """ test _cacerts_get() successful run """
        mock_req.side_effect = Exception('exc_simple_enroll')
        mock_to_pem.return_value = 'pem'
        self.cahandler.est_host = 'foo'
    ...
    def test_035_enroll(self, mock_ca):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._cacerts_get')
    def test_036_enroll(self, mock_ca):
    ...
    @patch('examples.ca_handler.est_ca_handler.CAhandler._cacerts_get')
    def test_037_enroll(self, mock_ca):
    ...
    def test_047__pkcs7_to_pem(self):
    ...
    def test_051__pkcs7_to_pem(self, mock_load):
        """ test pkcs7 to pem output list """
        with open(self.dir_path + '/ca/certs.p7b', 'r') as fso:
            file_content = fso.read()
