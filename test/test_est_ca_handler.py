...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_056_get_certificates(self):
    ...
    def test_057_get_certificates(self, mock_num):
    ...
    def test_063__pkcs7_to_pem(self, mock_load):
        """ test pkcs7 to pem output list """
        with open(self.dir_path + '/ca/certs.p7b', 'r') as fso:
            file_content = fso.read()
        response = Mock()
    ...
    @patch('OpenSSL.crypto.load_pkcs7_data')
    def test_064__pkcs7_to_pem(self, mock_load):
