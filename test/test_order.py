...
class TestOrderClass(unittest.TestCase):
    def test_001_process_csr_dryrun_skipped(self):
        ...
        with patch("acme2certifier.acme_srv.helper.b64_url_recode", return_value="csrval"):
    ...
    def test_003__enter_(self):
        """test enter"""
        self.order.__exit__()

    def test_004_are_identifiers_allowed_logging(self):
    ...
    def test_007_is_profile_valid_invalid_override(self):
        self.order.config.profiles_check_disable = False
    ...
    def test_008_is_profile_valid_valid_profile(self):
    ...
    def test_009_add_profile_to_order_valid(self):
        self.order.config.profiles = {"foo": {}}
        self.order.config.profiles_check_disable = False
        data_dic = {}
        payload = {"profile": "foo"}
    ...
    def test_010_add_profile_to_order_invalid(self):
    ...
    def test_011_add_profile_to_order_no_profiles_configured(self):
        self.order.config.profiles = {}
        self.order.config.profiles_check_disable = False
        data_dic = {}
        payload = {"profile": "foo"}
    ...
    def test_012_add_profile_to_order_single_profile_overwrite(self):
        self.order.config.profiles = {"bar": True}
        self.order.config.profiles_check_disable = False
    ...
    def test_013_process_order_request_db_error_logging(self):
    ...
    def test_014_edge_case_empty_identifiers(self):
    ...
    def test_015_edge_case_too_many_identifiers(self):
    ...
    def test_016_edge_case_invalid_identifier_type(self):
    ...
    def test_017_edge_case_missing_type(self):
    ...
    def test_018_edge_case_invalid_profile_config(self):
    ...
    def test_019_order_dic_create_all_fields(self):
    ...
    def test_020_order_dic_create_invalid_identifiers(self):
    ...
    def test_021_get_authorization_list_db_error(self):
    ...
    def test_022_update_validity_list_ready(self):
    ...
    def test_023_update_validity_list_not_ready(self):
    ...
    def test_024_get_order_details_with_authz(self):
    ...
    def test_025_invalidate_expired_orders(self):
    ...
    def test_026_create_from_content_success(self):
    ...
    def test_027_create_from_content_rejected(self):
    ...
    def test_028_create_from_content_error(self):
    ...
    def test_029_create_from_content_check_fail(self):
    ...
    def test_030_parse_order_message_all_paths(self):
    ...
    def test_031_parse_order_content_success(self):
    ...
    def test_032_parse_order_content_expiry_disabled(self):
    ...
    def test_033_legacy_api_compatibility(self):
    ...
    def test_034_add_order_and_authorizations_success(self):
    ...
    def test_035_add_order_and_authorizations_order_db_error(self):
    ...
    def test_036_add_order_and_authorizations_authz_db_error(self):
    ...
    def test_037_add_order_and_authorizations_with_error_input(self):
    ...
    def test_038_add_order_and_authorizations_logging(self):
        self.order.repository.add_order.return_value = "oid"
        self.order.repository.add_authorization.return_value = None
        payload = {"identifiers": [{"type": "dns", "value": "example.com"}]}
        data_dic = {"foo": "bar"}
    ...
    def test_039_load_header_info_config_valid(self):
    ...
    def test_043_load_order_config_all_options(self):
        import configparser
    ...
    def test_044_load_order_config_invalid_ints(self):
        import configparser
    ...
    def test_045_load_order_config_missing_sections(self):
        import configparser
    ...
    def test_046_create_order_invalid_identifiers(self):
    ...
    def test_047_create_order_profile_invalid(self):
    ...
    def test_048_create_order_add_order_and_authz_error(self):
    ...
    def test_049_create_order_no_identifiers(self):
        # Payload missing 'identifiers', triggers unsupportedidentifier error
        payload = {"profile": "foo"}
        account_name = "acct"
        with (
            patch("acme2certifier.acme_srv.order.generate_random_string", return_value="randomstring"),
    ...
    def test_050_create_order_logging(self):
        # Check all log messages with severity INFO and higher
        # Use unified logger and log_stream
        with (
            patch(
                "acme2certifier.acme_srv.helper.generate_random_string", return_value="randomstring"
            ),
            patch("acme2certifier.acme_srv.helper.uts_now", return_value=1234567890),
            patch(
                "acme2certifier.acme_srv.helper.uts_to_date_utc", return_value="2026-01-01T00:00:00Z"
            ),
        ):
            with (
                patch.object(
    ...
    def test_051_load_profile_config_all_paths(self):
    ...
    def test_052_load_profile_config_all_paths(self):
        with patch.object(self.order, "_load_profiles_from_config") as m1:
            with patch.object(self.order, "_load_profiles_from_db_if_sync") as m2:
                with patch.object(self.order, "_maybe_disable_profile_check") as m3:
                    with self.assertLogs("test_a2c", level="DEBUG") as log_cm:
    ...
    def test_053_load_profiles_from_config_with_profiles(self):
    ...
    def test_054_load_profiles_from_config_no_profiles(self):
    ...
    def test_055_load_profiles_from_db_if_sync_profiles_sync_true(self):
    ...
    def test_056_load_profiles_from_db_if_sync_profiles_sync_false(self):
    ...
    def test_057_load_profiles_from_db_if_sync_no_profiles_sync(self):
    ...
    def test_058_load_profiles_from_db_if_sync_db_error(self):
    ...
    def test_059_set_profiles_from_db_valid_json(self):
    ...
    def test_060_set_profiles_from_db_invalid_json(self):
        # Should log error on invalid JSON
        with patch.object(self.order.logger, "error") as mock_log:
            self.order._set_profiles_from_db("notjson")
            mock_log.assert_called()

    def test_061_maybe_disable_profile_check_true(self):
    ...
    def test_062_maybe_disable_profile_check_false(self):
    ...
    def test_063_maybe_disable_profile_check_no_profiles(self):
    ...
    def test_064_load_configuration_authz_validity_error(self):
    ...
    def test_065_load_configuration_without_ordersection(self):
    ...
    def test_066_name_get_logging(self):
        with patch(
            "acme2certifier.acme_srv.order.parse_url", return_value={"path": "/acme/order/ord123"}
        ):
            result = self.order._name_get("/acme/order/ord123")
            self.assertEqual(result, "ord123")

    def test_067_name_get_with_slash(self):
    ...
    def test_068_name_get_logging(self):
        # Should log debug messages using central logger and log_stream
        with patch(
            "acme2certifier.acme_srv.order.parse_url", return_value={"path": "/acme/order/ord789"}
        ):
            with self.assertLogs("test_a2c", level="DEBUG") as log_cm:
    ...
    def test_069_are_identifiers_allowed_valid(self):
        # Should return None for valid identifiers
        with patch("acme2certifier.acme_srv.order.validate_identifier", return_value=True):
            result = self.order.are_identifiers_allowed(
                [{"type": "dns", "value": "foo.com"}]
            )
            self.assertEqual(result, (None, None))

    def test_070_are_identifiers_allowed_invalid_type(self):
    ...
    def test_071_are_identifiers_allowed_invalid_value(self):
        # Should return rejectedidentifier if validate_identifier returns False
        with patch("acme2certifier.acme_srv.order.validate_identifier", return_value=False):
            result = self.order.are_identifiers_allowed(
                [{"type": "dns", "value": "foo.com"}]
            )
            self.assertEqual(
    ...
    def test_072_are_identifiers_allowed_missing_type(self):
    ...
    def test_073_are_identifiers_allowed_tnauthlist_and_email(self):
    ...
    def test_074_are_identifiers_allowed_wildcard_rejected_when_disabled(self):
    ...
    def test_075_are_identifiers_allowed_wildcard_allowed_when_not_disabled(self):
    ...
    def test_076_rewrite_email_identifiers_basic(self):
    ...
    def test_077_rewrite_email_identifiers_no_rewrite(self):
    ...
    def test_078_rewrite_email_identifiers_other_types(self):
    ...
    def test_079_rewrite_email_identifiers_logging(self):
    ...
    def test_080_name_get_basic(self):
        # Should log debug messages using central logger and log_stream
        with patch(
            "acme2certifier.acme_srv.order.parse_url", return_value={"path": "/acme/order/ord123"}
        ):
    ...
    def test_081_process_csr_all_paths(self):
    ...
    def test_082_process_csr_rejected_identifier(self):
    ...
    def test_083_process_csr_serverinternal_error(self):
    ...
    def test_084_process_csr_certificate_store_failure(self):
    ...
    def test_085_finalize_order_all_paths(self):
    ...
    def test_086_finalize_csr_updates_status_when_no_detail(self):
    ...
    def test_087_finalize_csr_handles_timeout(self):
    ...
    def test_088_finalize_csr_handles_rejected_identifier(self):
    ...
    def test_089_finalize_csr_else_branch_passes_through_detail(self):
    ...
    def test_090_finalize_csr_else_branch_generic_fallback(self):
    ...
    def test_091_process_csr_applies_eab_profile_and_forwards_flag(self):
        with patch(
    ...
    def test_092_order_dic_create_all_paths(self):
    ...
    def test_093_get_authorization_list_all_paths(self):
        self.order.repository.authorization_lookup.return_value = [
            {"name": "auth1", "status__name": "valid"}
        ]
        self.assertEqual(
    ...
    def test_094_get_authorization_list_all_paths(self):
        # DB error path
    ...
    def test_095_update_validity_list_all_paths(self):
    ...
    def test_096_get_order_details_all_paths(self):
    ...
    def test_097_invalidate_expired_orders_all_paths(self):
    ...
    def test_098_invalidate_expired_orders_all_paths(self):
        # DB error path
    ...
    def test_099_process_order_request_all_paths(self):
    ...
    def test_100_check_identifiers_validity_all_paths(self):
    ...
    def test_101_check_identifiers_validity_all_paths(self):
        with patch(
    ...
    def test_102_get_order_info_all_paths(self):
    ...
    def test_103_get_order_info_all_paths(self):
    ...
    def test_104_header_info_lookup_all_paths(self):
    ...
    def test_105_enter_loads_configuration_and_returns_self(self):
    ...
    def test_106_parse_order_content_adds_certificate(self):
    ...
    def test_107_invalidate_expired_orders_update_error_logging(self):
    ...
    def test_108_process_csr_generic_error(self):
    ...
    def test_109_process_csr_serverinternal_error(self):
    ...
    def test_110_process_order_request_db_error_logging(self):
    ...
    def test_111_process_order_request_no_url(self):
    ...
    def test_112_finalize_order_valid_OrderDatabaseError(self):
    ...
    def test_113_finalize_order_ready_nocsr(self):
        # Covers lines 593-597: status not ready
    ...
    def test_114_finalize_csr_timeout(self):
    ...
    def test_115_from_content_rejectedidentifier_with_detail(self):
    ...
    def test_116_from_content_rejectedidentifier_without_detail(self):
        # Ensure the 'rejectedidentifier' error branch is covered
        rejected = self.order.error_msg_dic["rejectedidentifier"]
        with patch.object(
            self.order.message,
    ...
    def test_117_apply_eab_profile_eab_profiling_disabled(self):
    ...
    def test_118_apply_eab_profile_account_lookup_db_error(self):
        self.order.config.eab_profiling = True
    ...
    def test_119_apply_eab_profile_no_eab_kid(self):
        self.order.config.eab_profiling = True
    ...
    def test_120_apply_eab_profile_allowed_domainlist_order_section(self):
        self.order.config.eab_profiling = True
    ...
    def test_121_apply_eab_profile_allowed_domainlist_cahandler_section(self):
        self.order.config.eab_profiling = True
    ...
    def test_122_apply_eab_profile_wildcard_disable_false_order_section(self):
        self.order.config.eab_profiling = True
        self.order.config.wildcard_certificate_disable = True
    ...
    def test_124_load_eab_profile_param_empty_list_in_order_section(self):
    ...
    def test_125_load_eab_profile_param_empty_string_in_order_section(self):
    ...
    def test_126_load_eab_profile_param_order_section_has_precedence(self):
        profile_dic = {
            "kid_precedence": {
    ...
    def test_127_load_eab_profile_param_returns_default_if_param_missing(self):
    ...
    def test_128_apply_eab_profile_generic_exception(self):
        self.order.config.eab_profiling = True
    ...
    def test_129_create_order_eab_profiling_branch(self):
    ...
    def test_130_create_order_invalid_profile_detail(self):
    ...
    def test_131_are_identifiers_allowed_fqdn_not_whitelisted(self):
        # Covers: FQDN/SAN not allowed by configuration (lines 551-566)
        with (
            patch("acme2certifier.acme_srv.order.validate_identifier", return_value=True),
            patch("acme2certifier.acme_srv.order.is_domain_whitelisted", return_value=False),
        ):
    ...
    def test_132_check_single_identifier_wildcard_flag_reconstructs_for_domainlist(
        self,
    ):
    ...
    def test_133_check_single_identifier_non_wildcard_skips_reconstruct_and_rejects(
        self,
    ):
    ...
    def test_134_apply_eab_profile_disabled(self):
    ...
    def test_135_check_single_identifier_missing_type(self):
    ...
    def test_136_check_single_identifier_wrong_type(self):
        # Covers error message for missing 'type' (line 556)
    ...
    def test_137_check_single_identifier_invalid_value(self):
    ...
    def test_138_add_authorizations_to_db_success(self):
    ...
    def test_139_add_authorizations_to_db_malformed(self):
    ...
    def test_140_add_authorizations_to_db_db_error(self):
    ...
    def test_141_add_authorizations_to_db_sectigo_sim(self):
    ...
    def test_142_create_from_content_malformed_identifier(self):
    ...
    def test_143_load_configuration_directory_url_prefix(self):
        ...
        config_dic.add_section("Order")
        config_dic.add_section("Authorization")
        with patch("acme2certifier.acme_srv.order.load_config", return_value=config_dic):
            self.order.path_dic = {
    ...
    def test_144_check_single_identifier_missing_value(self):
    ...
    def test_145_is_profile_valid_dryrun_profile_logging(self):
    ...
    def test_146_add_profile_to_order_dryrun_profile_logging(self):
    ...
    def test_147_finalize_csr_handles_dryrun_skipped(self):
    ...
    def test_148_are_identifiers_allowed_ip_not_whitelisted(self):
        ...
        with patch("acme2certifier.acme_srv.order.is_ip_whitelisted", return_value=False):
        ...
        with patch("acme2certifier.acme_srv.order.is_ip_whitelisted", return_value=True):
            error, msg = self.order.are_identifiers_allowed([identifier])
            self.assertIsNone(error)
            self.assertIsNone(msg)

    def test_149_are_identifiers_allowed_ip_whitelisted(self):
    ...
    def test_150_are_identifiers_allowed_ip_not_whitelisted(self):
        # Should reject IP if not in allowed_iplist
        with (
            patch("acme2certifier.acme_srv.order.validate_identifier", return_value=True),
            patch("acme2certifier.acme_srv.order.is_ip_whitelisted", return_value=False),
        ):
            self.order.config.allowed_iplist = ["192.168.1.1", "10.0.0.0/8"]
            result = self.order.are_identifiers_allowed(
    ...
    def test_151_are_identifiers_allowed_iplist_empty(self):
    ...
    def test_152_are_identifiers_allowed_multiple_ips(self):
        # Should reject on first non-whitelisted IP, allow if all whitelisted
        with (
            patch("acme2certifier.acme_srv.order.validate_identifier", return_value=True),
            patch("acme2certifier.acme_srv.order.is_ip_whitelisted", side_effect=[True, False]),
        ):
        ...
        with (
            patch("acme2certifier.acme_srv.order.validate_identifier", return_value=True),
            patch("acme2certifier.acme_srv.order.is_ip_whitelisted", side_effect=[True, True]),
        ):
            self.order.config.allowed_iplist = ["10.0.0.0/8"]
            result = self.order.are_identifiers_allowed(
                [
    ...
    def test_153_load_profile_mapping_field_returns_none_without_module(self):
    ...
    def test_154_load_profile_mapping_field_from_module_attribute(self):
        ca_module = types.SimpleNamespace(profile_mapping_field="module_profile")

        with patch("acme2certifier.acme_srv.order.ca_handler_load", return_value=ca_module):
            result = self.order._load_profile_mapping_field({})

        self.assertEqual(result, "module_profile")

    def test_155_load_profile_mapping_field_from_instance_attribute(self):
    ...
    def test_156_load_profile_mapping_field_from_noarg_instance_fallback(self):
        class DummyCAhandler:
            def __init__(self):
    ...
    def test_157_load_profile_mapping_field_from_class_attribute(self):
        class DummyCAhandler:
    ...
    def test_158_load_profile_mapping_field_returns_none_without_handler_class(self):
        ca_module = types.SimpleNamespace()

        with patch("acme2certifier.acme_srv.order.ca_handler_load", return_value=ca_module):
            self.assertIsNone(self.order._load_profile_mapping_field({}))

    def test_159_load_profile_mapping_field_class_fallback_after_empty_instance(self):
        class DummyCAhandler:
            profile_mapping_field = "class_profile"
    ...
    def test_160_load_profile_mapping_field_returns_none_when_not_defined(self):
        class DummyCAhandler:
            def __init__(self, logger=None):
                self.logger = logger
                self.profile_mapping_field = None
    ...
    def test_161_load_profile_mapping_field_warns_when_noarg_fallback_fails(self):
        class DummyCAhandler:
            def __init__(self):
    ...
    def test_162_load_profile_mapping_field_warns_when_logger_init_fails(self):
        class DummyCAhandler:
            def __init__(self, logger=None):
    ...
    def test_163_profile_mapping_to_dict_none(self):
        self.assertEqual(self.order._profile_mapping_to_dict(None), {})

    def test_164_profile_mapping_to_dict_string(self):
        self.assertEqual(
    ...
    def test_165_profile_mapping_to_dict_list(self):
    ...
    def test_166_profile_mapping_to_dict_dict_passthrough(self):
        value = {"profile_a": True, "profile_b": False}
        self.assertEqual(self.order._profile_mapping_to_dict(value), value)

    def test_167_profile_mapping_to_dict_unsupported_type(self):
        with self.assertLogs("test_a2c", level="WARNING") as log_cm:
    ...
    def test_168_load_eab_profile_mapping_without_mapping_field(self):
        self.order.config.profile_mapping_field = None
        self.assertEqual(self.order._load_eab_profile_mapping({"kid": {}}, "kid"), {})

    def test_169_load_eab_profile_mapping_uses_param_and_normalizer(self):
    ...
    def test_170_apply_eab_profile_mapping_updates_profiles(self):
    ...
    def test_171_apply_eab_profile_mapping_noop_for_empty_mapping(self):
    ...
    def test_172_get_order_account_name_success(self):
    ...
    def test_173_get_order_account_name_fallback_account_key(self):
    ...
    def test_174_get_order_account_name_empty_lookup(self):
    ...
    def test_175_get_order_account_name_db_error(self):
    ...
    def test_176_identifier_errors_include_account_order_correlation(self):
    ...
    def test_177_create_order_threads_correlation_into_identifier_errors(self):
    ...
    def test_178_finalize_order_not_ready_missing_status(self):
    ...
    def test_179_create_from_content_does_not_relog_create_failures(self):
