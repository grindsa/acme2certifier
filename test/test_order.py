...
class TestOrderRepository(unittest.TestCase):
    ...
    def test_012_order_update_if_status_success(self):
        self.order_repository.dbstore.order_update_if_status.return_value = 1
        self.assertEqual(
            self.order_repository.order_update_if_status("o1", "processing", "ready"),
            1,
        )
        self.order_repository.dbstore.order_update_if_status.assert_called_once_with(
            "o1", "processing", "ready"
        )

    def test_013_order_update_if_status_failure(self):
        self.order_repository.dbstore.order_update_if_status.side_effect = Exception(
            "fail"
        )
        with self.assertRaises(Exception) as context:
            with self.assertLogs("test_a2c", level="CRITICAL") as log_cm:
                self.order_repository.order_update_if_status(
                    "o1", "processing", "ready"
                )
        self.assertIn(
            "Failed conditional order status update: fail", str(context.exception)
        )
        self.assertIn(
            "CRITICAL:test_a2c:Database error: failed conditional order status update: fail",
            log_cm.output,
        )

    def test_014_authorization_lookup_success(self):
    ...
    def test_015_authorization_lookup_failure(self):
    ...
    def test_016_certificate_lookup_success(self):
    ...
    def test_017_certificate_lookup_failure(self):
    ...
    def test_018_hkparameter_get_success(self):
    ...
    def test_019_hkparameter_get_failure(self):
    ...
    def test_020_orders_invalid_search_success(self):
    ...
    def test_021_orders_invalid_search_failure(self):
    ...
    def test_022_account_lookup_success(self):
    ...
    def test_023_account_lookup_failure(self):
...
class TestOrderClass(unittest.TestCase):
    def test_024_process_csr_dryrun_skipped(self):
    ...
    def test_025__enter_(self):
        """test enter"""
        self.order.__enter__()

    def test_026__enter_(self):
        """test enter"""
        self.order.__exit__()

    def test_027_are_identifiers_allowed_logging(self):
    ...
    def test_030_is_profile_valid_invalid_override(self):
        self.order.config.profiles_check_disable = False
        self.order.config.profiles = {"bar": True}
        with self.assertLogs("test_a2c", level="INFO") as log_cm:
            self.assertFalse(self.order.is_profile_valid("foo"))
        self.assertIn(
    ...
    def test_031_is_profile_valid_valid_profile(self):
    ...
    def test_032_add_profile_to_order_valid(self):
        self.order.config.profiles = {"foo": {}}
        self.order.config.profiles_check_disable = False
        data_dic = {}
        payload = {"profile": "foo"}
    ...
    def test_033_add_profile_to_order_invalid(self):
    ...
    def test_034_add_profile_to_order_no_profiles_configured(self):
        self.order.config.profiles = {}
        self.order.config.profiles_check_disable = False
        data_dic = {}
        payload = {"profile": "foo"}
    ...
    def test_035_add_profile_to_order_single_profile_overwrite(self):
        self.order.config.profiles = {"bar": True}
        self.order.config.profiles_check_disable = False
        ...
        self.assertIsNone(error)
        self.assertEqual(updated_dic["profile"], "bar")
        self.assertIn(
            "INFO:test_a2c:Order.add_profile_to_order(): overwriting submitted profile 'foo' with 'bar'.",
            log_cm.output,
        )

    def test_036_process_order_request_db_error_logging(self):
    ...
    def test_037_edge_case_empty_identifiers(self):
    ...
    def test_038_edge_case_too_many_identifiers(self):
    ...
    def test_039_edge_case_invalid_identifier_type(self):
    ...
    def test_040_edge_case_missing_type(self):
    ...
    def test_041_edge_case_invalid_profile_config(self):
    ...
    def test_042_order_dic_create_all_fields(self):
    ...
    def test_043_order_dic_create_invalid_identifiers(self):
    ...
    def test_044_get_authorization_list_db_error(self):
    ...
    def test_045_update_validity_list_ready(self):
    ...
    def test_046_update_validity_list_not_ready(self):
    ...
    def test_047_get_order_details_with_authz(self):
    ...
    def test_048_invalidate_expired_orders(self):
    ...
    def test_049_create_from_content_success(self):
    ...
    def test_050_create_from_content_rejected(self):
    ...
    def test_051_create_from_content_error(self):
    ...
    def test_052_create_from_content_check_fail(self):
    ...
    def test_053_parse_order_message_all_paths(self):
    ...
    def test_054_parse_order_content_success(self):
    ...
    def test_055_parse_order_content_expiry_disabled(self):
    ...
    def test_056_legacy_api_compatibility(self):
    ...
    def test_057_add_order_and_authorizations_success(self):
    ...
    def test_058_add_order_and_authorizations_order_db_error(self):
    ...
    def test_059_add_order_and_authorizations_authz_db_error(self):
    ...
    def test_060_add_order_and_authorizations_with_error_input(self):
    ...
    def test_061_add_order_and_authorizations_logging(self):
        self.order.repository.add_order.return_value = "oid"
        self.order.repository.add_authorization.return_value = None
        payload = {"identifiers": [{"type": "dns", "value": "example.com"}]}
        data_dic = {"foo": "bar"}
    ...
    def test_062_load_header_info_config_valid(self):
    ...
    def test_066_load_order_config_all_options(self):
        import configparser
    ...
    def test_067_load_order_config_invalid_ints(self):
        import configparser
    ...
    def test_068_load_order_config_missing_sections(self):
        import configparser
    ...
    def test_069_create_order_invalid_identifiers(self):
    ...
    def test_070_create_order_profile_invalid(self):
    ...
    def test_071_create_order_add_order_and_authz_error(self):
    ...
    def test_072_create_order_no_identifiers(self):
    ...
    def test_073_create_order_logging(self):
    ...
    def test_074_load_profile_config_all_paths(self):
    ...
    def test_075_load_profile_config_all_paths(self):
        with patch.object(self.order, "_load_profiles_from_config") as m1:
            with patch.object(self.order, "_load_profiles_from_db_if_sync") as m2:
                with patch.object(self.order, "_maybe_disable_profile_check") as m3:
                    with self.assertLogs("test_a2c", level="DEBUG") as log_cm:
    ...
    def test_076_load_profiles_from_config_with_profiles(self):
    ...
    def test_077_load_profiles_from_config_no_profiles(self):
    ...
    def test_078_load_profiles_from_db_if_sync_profiles_sync_true(self):
    ...
    def test_079_load_profiles_from_db_if_sync_profiles_sync_false(self):
    ...
    def test_080_load_profiles_from_db_if_sync_no_profiles_sync(self):
    ...
    def test_081_load_profiles_from_db_if_sync_db_error(self):
    ...
    def test_082_set_profiles_from_db_valid_json(self):
    ...
    def test_083_set_profiles_from_db_invalid_json(self):
        # Should log error on invalid JSON
        with patch.object(self.order.logger, "error") as mock_log:
            self.order._set_profiles_from_db("notjson")
            mock_log.assert_called()

    def test_084_maybe_disable_profile_check_true(self):
    ...
    def test_085_maybe_disable_profile_check_false(self):
    ...
    def test_086_maybe_disable_profile_check_no_profiles(self):
    ...
    def test_087_load_configuration_authz_validity_error(self):
    ...
    def test_088_load_configuration_without_ordersection(self):
    ...
    def test_090_name_get_with_slash(self):
    ...
    def test_091_name_get_logging(self):
    ...
    def test_092_are_identifiers_allowed_valid(self):
    ...
    def test_093_are_identifiers_allowed_invalid_type(self):
    ...
    def test_094_are_identifiers_allowed_invalid_value(self):
    ...
    def test_095_are_identifiers_allowed_missing_type(self):
    ...
    def test_096_are_identifiers_allowed_tnauthlist_and_email(self):
    ...
    def test_097_are_identifiers_allowed_wildcard_rejected_when_disabled(self):
    ...
    def test_098_are_identifiers_allowed_wildcard_allowed_when_not_disabled(self):
    ...
    def test_099_rewrite_email_identifiers_basic(self):
    ...
    def test_100_rewrite_email_identifiers_no_rewrite(self):
    ...
    def test_101_rewrite_email_identifiers_other_types(self):
    ...
    def test_102_rewrite_email_identifiers_logging(self):
    ...
    def test_103_name_get_basic(self):
        # Should log debug messages using central logger and log_stream
        with patch(
            "acme2certifier.acme_srv.order.parse_url",
            return_value={"path": "/acme/order/ord123"},
    ...
    def test_108_finalize_order_all_paths(self):
        ...
        self.order.repository.authorization_lookup = MagicMock(
            return_value=[
                {"name": "az1", "status__name": "valid", "expires": 9999999999}
            ]
        )
        self.order._finalize_csr = MagicMock(return_value=(200, "msg", None, "cert"))
        result = self.order._finalize_order("order1", {"csr": "csrval"})
        self.assertEqual(result[0], 200)
        self.order.repository.order_update_if_status.assert_called_once_with(
            "order1", "processing", "ready"
        )
    ...
    def test_109_finalize_ready_cas_miss(self):
        """Second concurrent finalize loses ready→processing claim."""
        self.order._get_order_info = MagicMock(return_value={"status": "ready"})
        self.order.repository.order_update_if_status = MagicMock(return_value=0)
        self.order._finalize_csr = MagicMock()
        with self.assertLogs("test_a2c", level="WARNING") as log_cm:
            result = self.order._finalize_order("order1", {"csr": "csrval"})
        self.assertEqual(result[0], 403)
    ...
    def test_110_finalize_ready_authz_expired(self):
        """Stale ready order with expired authorization is rejected."""
        self.order._get_order_info = MagicMock(return_value={"status": "ready"})
        self.order.repository.order_update_if_status = MagicMock(return_value=1)
        self.order.repository.authorization_lookup = MagicMock(
            return_value=[
                {"name": "az1", "status__name": "valid", "expires": 1},
            ]
        )
    ...
    def test_111_finalize_ready_authz_not_valid(self):
        """Authorization not in valid state blocks issuance after CAS."""
        self.order._get_order_info = MagicMock(return_value={"status": "ready"})
        self.order.repository.order_update_if_status = MagicMock(return_value=1)
        self.order.repository.authorization_lookup = MagicMock(
            return_value=[
    ...
    def test_112_finalize_ready_expires_zero_allowed(self):
        """expires==0 means never-expire and still allows issuance."""
        self.order._get_order_info = MagicMock(return_value={"status": "ready"})
        self.order.repository.order_update_if_status = MagicMock(return_value=1)
        self.order.repository.authorization_lookup = MagicMock(
            return_value=[
                {"name": "az1", "status__name": "valid", "expires": 0},
            ]
        )
        self.order._finalize_csr = MagicMock(return_value=(200, None, None, "cert"))
        result = self.order._finalize_order("order1", {"csr": "csrval"})
        self.assertEqual(result[0], 200)
        self.order._finalize_csr.assert_called_once()

    def test_113_finalize_csr_updates_status_when_no_detail(self):
    ...
    def test_114_finalize_csr_handles_timeout(self):
    ...
    def test_115_finalize_csr_handles_rejected_identifier(self):
    ...
    def test_116_finalize_csr_else_branch_passes_through_detail(self):
    ...
    def test_117_finalize_csr_else_branch_generic_fallback(self):
    ...
    def test_118_process_csr_applies_eab_profile_and_forwards_flag(self):
        with patch(
            "acme2certifier.acme_srv.helper.b64_url_recode", return_value="csrval"
        ):
    ...
    def test_119_order_dic_create_all_paths(self):
    ...
    def test_120_get_authorization_list_all_paths(self):
        self.order.repository.authorization_lookup.return_value = [
            {"name": "auth1", "status__name": "valid"}
        ]
        self.assertEqual(
    ...
    def test_121_get_authorization_list_all_paths(self):
        # DB error path
    ...
    def test_122_update_validity_list_all_paths(self):
    ...
    def test_123_get_order_details_all_paths(self):
    ...
    def test_124_invalidate_expired_orders_all_paths(self):
    ...
    def test_125_invalidate_expired_orders_all_paths(self):
        # DB error path
    ...
    def test_126_process_order_request_all_paths(self):
    ...
    def test_127_check_identifiers_validity_all_paths(self):
    ...
    def test_128_check_identifiers_validity_all_paths(self):
        with patch(
            "acme2certifier.acme_srv.order.validate_identifier", return_value=False
        ):
            self.order.config.identifier_limit = 2
    ...
    def test_129_get_order_info_all_paths(self):
    ...
    def test_130_get_order_info_all_paths(self):
    ...
    def test_131_header_info_lookup_all_paths(self):
    ...
    def test_132_enter_loads_configuration_and_returns_self(self):
    ...
    def test_133_parse_order_content_adds_certificate(self):
    ...
    def test_134_invalidate_expired_orders_update_error_logging(self):
    ...
    def test_135_process_csr_generic_error(self):
    ...
    def test_136_process_csr_serverinternal_error(self):
    ...
    def test_137_process_order_request_db_error_logging(self):
    ...
    def test_138_process_order_request_no_url(self):
    ...
    def test_139_finalize_order_valid_OrderDatabaseError(self):
    ...
    def test_140_finalize_order_ready_nocsr(self):
        # Missing CSR is rejected before claiming ready→processing.
        self.order.repository.order_lookup.return_value = {"status": "ready"}
        self.order.repository.order_update_if_status = MagicMock()
        with self.assertLogs("test_a2c", level="WARNING") as log_cm:
            result = self.order._finalize_order("ordername", {}, None)
        self.assertEqual(result[0], 400)
        ...
        self.assertIsNone(result[3])
        self.order.repository.order_update_if_status.assert_not_called()
        self.assertIn(
            "WARNING:test_a2c:Order finalize failed: csr missing order=ordername",
            log_cm.output,
        )

    def test_141_finalize_csr_timeout(self):
    ...
    def test_142_from_content_rejectedidentifier_with_detail(self):
    ...
    def test_143_from_content_rejectedidentifier_without_detail(self):
        # Ensure the 'rejectedidentifier' error branch is covered
        rejected = self.order.error_msg_dic["rejectedidentifier"]
        with patch.object(
            self.order.message,
    ...
    def test_144_apply_eab_profile_eab_profiling_disabled(self):
    ...
    def test_145_apply_eab_profile_account_lookup_db_error(self):
        self.order.config.eab_profiling = True
    ...
    def test_146_apply_eab_profile_no_eab_kid(self):
        self.order.config.eab_profiling = True
    ...
    def test_147_apply_eab_profile_allowed_domainlist_order_section(self):
        self.order.config.eab_profiling = True
    ...
    def test_148_apply_eab_profile_allowed_domainlist_cahandler_section(self):
        self.order.config.eab_profiling = True
    ...
    def test_149_apply_eab_profile_wildcard_disable_false_order_section(self):
        self.order.config.eab_profiling = True
        self.order.config.wildcard_certificate_disable = True
    ...
    def test_150_apply_eab_profile_wildcard_disable_string_false(self):
        self.order.config.eab_profiling = True
        self.order.config.wildcard_certificate_disable = True
        self.order.repository.account_lookup.return_value = {"eab_kid": "kid_false"}
        mock_eab_handler = MagicMock()
    ...
    def test_151_apply_eab_profile_ca_error_details_forward_string_false(self):
        self.order.config.eab_profiling = True
        self.order.config.ca_error_details_forward = True
        self.order.repository.account_lookup.return_value = {"eab_kid": "kid_false"}
        mock_eab_handler = MagicMock()
    ...
    def test_152_apply_eab_profile_ca_error_details_forward_string_true(self):
        self.order.config.eab_profiling = True
        self.order.config.ca_error_details_forward = False
    ...
    def test_153_load_eab_profile_param_false_cahandler_section(self):
        profile_dic = {
            "kid_false": {"cahandler": {"wildcard_certificate_disable": False}}
        }
        with self.assertLogs("test_a2c", level="WARNING") as log_cm:
            value = self.order._load_eab_profile_param(
                profile_dic, "kid_false", "wildcard_certificate_disable", True
            )

        self.assertFalse(value)
        self.assertIn(
            "WARNING:test_a2c:wildcard_certificate_disable parameter found in cahandler section of the eab-profile - this is deprecated, please use the order section",
            log_cm.output,
        )

    def test_154_load_eab_profile_param_empty_list_in_order_section(self):
    ...
    def test_155_load_eab_profile_param_empty_string_in_order_section(self):
    ...
    def test_156_load_eab_profile_param_order_section_has_precedence(self):
        profile_dic = {
            "kid_precedence": {
                "order": {"wildcard_certificate_disable": False},
                "cahandler": {"wildcard_certificate_disable": True},
            }
        }
        value = self.order._load_eab_profile_param(
            profile_dic, "kid_precedence", "wildcard_certificate_disable", True
        )
        self.assertFalse(value)

    def test_157_load_eab_profile_param_returns_default_if_param_missing(self):
    ...
    def test_158_apply_eab_profile_generic_exception(self):
        self.order.config.eab_profiling = True
    ...
    def test_159_create_order_eab_profiling_branch(self):
    ...
    def test_160_create_order_invalid_profile_detail(self):
    ...
    def test_161_are_identifiers_allowed_fqdn_not_whitelisted(self):
    ...
    def test_162_check_single_identifier_wildcard_flag_reconstructs_for_domainlist(
        self,
    ):
    ...
    def test_163_check_single_identifier_non_wildcard_skips_reconstruct_and_rejects(
        self,
    ):
    ...
    def test_164_apply_eab_profile_disabled(self):
    ...
    def test_165_check_single_identifier_missing_type(self):
    ...
    def test_166_check_single_identifier_wrong_type(self):
        # Covers error message for missing 'type' (line 556)
    ...
    def test_167_check_single_identifier_invalid_value(self):
    ...
    def test_168_add_authorizations_to_db_success(self):
    ...
    def test_169_add_authorizations_to_db_malformed(self):
    ...
    def test_170_add_authorizations_to_db_db_error(self):
    ...
    def test_171_add_authorizations_to_db_sectigo_sim(self):
    ...
    def test_172_create_from_content_malformed_identifier(self):
    ...
    def test_173_load_configuration_directory_url_prefix(self):
    ...
    def test_174_check_single_identifier_missing_value(self):
    ...
    def test_175_is_profile_valid_dryrun_profile_logging(self):
    ...
    def test_176_add_profile_to_order_dryrun_profile_logging(self):
    ...
    def test_177_finalize_csr_handles_dryrun_skipped(self):
    ...
    def test_178_are_identifiers_allowed_ip_not_whitelisted(self):
    ...
    def test_179_are_identifiers_allowed_ip_whitelisted(self):
    ...
    def test_180_are_identifiers_allowed_ip_not_whitelisted(self):
    ...
    def test_181_are_identifiers_allowed_iplist_empty(self):
    ...
    def test_182_are_identifiers_allowed_multiple_ips(self):
    ...
    def test_183_load_profile_mapping_field_returns_none_without_module(self):
    ...
    def test_184_load_profile_mapping_field_from_module_attribute(self):
    ...
    def test_185_load_profile_mapping_field_from_instance_attribute(self):
        class DummyCAhandler:
            def __init__(self, logger=None):
                self.logger = logger
                self.profile_mapping_field = "instance_profile"
    ...
    def test_186_load_profile_mapping_field_from_noarg_instance_fallback(self):
        class DummyCAhandler:
            def __init__(self):
    ...
    def test_187_load_profile_mapping_field_from_class_attribute(self):
        class DummyCAhandler:
    ...
    def test_188_load_profile_mapping_field_returns_none_without_handler_class(self):
    ...
    def test_189_load_profile_mapping_field_class_fallback_after_empty_instance(self):
        class DummyCAhandler:
            profile_mapping_field = "class_profile"

            def __init__(self, logger=None):
                self.logger = logger
                # Shadow class attribute so instance lookup returns falsy and class fallback is used.
                self.profile_mapping_field = None
    ...
    def test_190_load_profile_mapping_field_returns_none_when_not_defined(self):
        class DummyCAhandler:
            def __init__(self, logger=None):
                self.logger = logger
                self.profile_mapping_field = None
    ...
    def test_191_load_profile_mapping_field_warns_when_noarg_fallback_fails(self):
        class DummyCAhandler:
            def __init__(self):
        ...
        self.assertTrue(
            any(
                "failed to instantiate CAhandler without logger" in msg
                for msg in log_cm.output
            )
        )

    def test_192_load_profile_mapping_field_warns_when_logger_init_fails(self):
        class DummyCAhandler:
            def __init__(self, logger=None):
        ...
        self.assertTrue(
            any(
                "failed to instantiate CAhandler with logger" in msg
                for msg in log_cm.output
            )
        )

    def test_193_profile_mapping_to_dict_none(self):
        self.assertEqual(self.order._profile_mapping_to_dict(None), {})

    def test_194_profile_mapping_to_dict_string(self):
        self.assertEqual(
    ...
    def test_195_profile_mapping_to_dict_list(self):
    ...
    def test_196_profile_mapping_to_dict_dict_passthrough(self):
        value = {"profile_a": True, "profile_b": False}
        self.assertEqual(self.order._profile_mapping_to_dict(value), value)

    def test_197_profile_mapping_to_dict_unsupported_type(self):
        with self.assertLogs("test_a2c", level="WARNING") as log_cm:
            self.assertEqual(self.order._profile_mapping_to_dict(42.0), {})
        self.assertIn(
            "WARNING:test_a2c:Unsupported profile mapping type: float",
            log_cm.output,
        )

    def test_198_load_eab_profile_mapping_without_mapping_field(self):
        self.order.config.profile_mapping_field = None
        self.assertEqual(self.order._load_eab_profile_mapping({"kid": {}}, "kid"), {})

    def test_199_load_eab_profile_mapping_uses_param_and_normalizer(self):
        self.order.config.profile_mapping_field = "template"
        with (
            patch.object(
                self.order,
                "_load_eab_profile_param",
                return_value="profile-a",
            ) as mock_load_param,
            patch.object(
                self.order,
                "_profile_mapping_to_dict",
                return_value={"profile-a": True},
            ) as mock_to_dict,
        ):
    ...
    def test_200_apply_eab_profile_mapping_updates_profiles(self):
        self.order.config.profiles = {"old": True}
        with self.assertLogs("test_a2c", level="DEBUG") as log_cm:
            self.order._apply_eab_profile_mapping("acct1", {"new": True})

        self.assertEqual(self.order.config.profiles, {"new": True})
        self.assertIn(
            "DEBUG:test_a2c:Order._apply_eab_profile() - overwrite profile information from eab profile for account acct1",
            log_cm.output,
        )

    def test_201_apply_eab_profile_mapping_noop_for_empty_mapping(self):
    ...
    def test_202_get_order_account_name_success(self):
    ...
    def test_203_get_order_account_name_fallback_account_key(self):
    ...
    def test_204_get_order_account_name_empty_lookup(self):
    ...
    def test_206_identifier_errors_include_account_order_correlation(self):
    ...
    def test_207_create_order_threads_correlation_into_identifier_errors(self):
    ...
    def test_208_finalize_order_not_ready_missing_status(self):
    ...
    def test_209_create_from_content_does_not_relog_create_failures(self):
    ...
    def test_210_apply_eab_profile_mapping_enables_profile_check(self):
        self.order.config.profiles_check_disable = True
        self.order._apply_eab_profile_mapping("acct1", {"web": True})
        self.assertFalse(self.order.config.profiles_check_disable)

    def test_211_apply_eab_profile_profiles_check_disable_true_string(self):
        self.order.config.profiles_check_disable = False
    ...
    def test_212_apply_eab_profile_profiles_check_disable_false_against_global_true(
        self,
    ):
        self.order.config.profiles_check_disable = True
        self._setup_eab_kid_profile(
    ...
    def test_213_apply_eab_profile_profiles_check_disable_missing_keeps_global(self):
        self.order.config.profiles_check_disable = False
        self._setup_eab_kid_profile("kid_missing", {"order": {}})
        self.order._apply_eab_profile("acct")
        self.assertFalse(self.order.config.profiles_check_disable)

    def test_214_apply_eab_profile_mapping_then_profiles_check_disable_true(self):
        self.order.config.profiles_check_disable = False
    ...
    def test_215_apply_eab_profile_profiles_check_disable_ignored_when_profiling_off(
        self,
    ):
        self.order.config.eab_profiling = False
        self.order.config.profiles_check_disable = False
