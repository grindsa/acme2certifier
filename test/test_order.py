...
class TestACMEHandler(unittest.TestCase):
    ...
    @patch('acme.order.Order._info')
    def test_021_order__csr_process(self, mock_oinfo):
    ...
    @patch('acme.order.Order._info')
    def test_022_order__csr_process(self, mock_oinfo, mock_certname, mock_import):
    ...
    @patch('acme.certificate.Certificate.store_csr')
    @patch('acme.order.Order._info')
    def test_023_order__csr_process(self, mock_oinfo, mock_certname, mock_enroll, mock_import):
    ...
    @patch('acme.certificate.Certificate.store_csr')
    @patch('acme.order.Order._info')
    def test_024_order__csr_process(self, mock_oinfo, mock_certname, mock_enroll, mock_import):
    ...
    def test_027_order__name_get(self):
        """ Order.name_get() http with parameters"""
        self.assertEqual('foo', self.order._name_get('http://tester.local/acme/order/foo?bar'))

    def test_028_order__name_get(self):
    ...
    def test_029_order__name_get(self):
    ...
    @patch('acme.message.Message.check')
    def test_030_order_parse(self, mock_mcheck):
    ...
    @patch('acme.message.Message.check')
    def test_031_order_parse(self, mock_mcheck):
    ...
    @patch('acme.message.Message.check')
    def test_032_order_parse(self, mock_mcheck, mock_oname):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_033_order_parse(self, mock_mcheck, mock_oname, mock_lookup):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_034_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_035_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process, mock_nnonce):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_036_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process, mock_nnonce):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_037_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process, mock_nnonce):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_038_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process, mock_nnonce):
    ...
    def test_039_order__identifiers_check(self):
    ...
    def test_040_order__identifiers_check(self):
    ...
    def test_041_order__identifiers_check(self):
    ...
    def test_042_order__identifiers_check(self):
    ...
    def test_043_order__identifiers_check(self):
    ...
    def test_054_order__process(self):
    ...
    def test_055_order__process(self):
    ...
    def test_056_order__process(self):
    ...
    @patch('acme.order.Order._info')
    def test_057_order__process(self, mock_info):
    ...
    @patch('acme.order.Order._info')
    def test_058_order__process(self, mock_info):
    ...
    @patch('acme.order.Order._info')
    def test_059_order__process(self, mock_info):
    ...
    @patch('acme.order.Order._info')
    def test_060_order__process(self, mock_info):
    ...
    @patch('acme.order.Order._info')
    def test_061_order__process(self, mock_info, mock_process_csr):
    ...
    @patch('acme.order.Order._csr_process')
    @patch('acme.order.Order._info')
    def test_062_order__process(self, mock_info, mock_process_csr, mock_update):
        """ Order.prcoess() finalize request with CSR but csr_process failed """
        mock_info.return_value = {'status': 'ready'}
        order_name = 'order_name'
        protected = {'url': {'finalize': 'foo', 'foo': 'bar'}}
    ...
    @patch('acme.certificate.Certificate.store_csr')
    @patch('acme.order.Order._info')
    def test_063_order__csr_process(self, mock_oinfo, mock_certname, mock_enroll, mock_import):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_064_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process, mock_nnonce):
    ...
    @patch('acme.order.Order._name_get')
    @patch('acme.message.Message.check')
    def test_065_order_parse(self, mock_mcheck, mock_oname, mock_lookup, mock_process, mock_nnonce):
    ...
    def test_066_order_invalidate(self):
    ...
    def test_067_order_invalidate(self):
    ...
    def test_068_order_invalidate(self):
    ...
    def test_069_order_invalidate(self):
    ...
    def test_070_order_invalidate(self):
    ...
    def test_072_order__add(self, mock_idchk):
    ...
    @patch('acme.order.Order._identifiers_check')
    def test_073_order__add(self, mock_idchk):
    ...
    def test_079_order_invalidate(self):
        """ test Order.invalidate - dbstore.order_update() raises an exception  """
