...
class TestHooks(unittest.TestCase):
    ...
    def test_017_load_configuration_smtp_port_587_defaults(self):
    ...
    def test_018_load_configuration_smtp_port_465_defaults(self):
    ...
    def test_022_done_already_sent_warning(self):
    ...
    def test_023_config_from_default_section(self):
    ...
    def test_024_config_hooks_precedence_over_default(self):
    ...
    def test_025_config_missing_both_sections_fails(self):
    ...
    def test_026_config_required_keys_from_mixed_sections(self):
    ...
    def test_027_get_config_int_from_hooks_section(self):
    ...
    def test_028_get_config_int_fallback_to_default_section(self):
    ...
    def test_029_get_config_int_with_fallback_value(self):
    ...
    def test_030_get_config_int_invalid_conversion(self):
    ...
    def test_031_get_config_int_edge_cases(self):
    ...
    def test_032_get_config_boolean_from_hooks_section(self):
    ...
    def test_033_get_config_boolean_fallback_to_default_section(self):
    ...
    def test_034_get_config_boolean_various_true_values(self):
    ...
    def test_035_get_config_boolean_various_false_values(self):
    ...
    def test_036_get_config_boolean_with_fallback_value(self):
    ...
    def test_037_get_config_boolean_already_boolean_type(self):
    ...
    def test_038_load_configuration_sender_falls_back_to_email_address(self):
    ...
    def test_039_done_handles_exception_and_logs_error(self):
    ...
    def test_042_clean_san_not_a_list(self):
    ...
    def test_043_clean_san_invalid_format(self):
    ...
    def test_044_attach_csr_success(self, mock_mimeapp, mock_build_pem):
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.MIMEApplication")
    def test_045_attach_csr_pem_build_fails(self, mock_mimeapp, mock_build_pem):
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.MIMEApplication")
    def test_046_attach_csr_exception(self, mock_mimeapp, mock_build_pem):
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.MIMEApplication")
    def test_047_attach_cert_success(
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.MIMEApplication")
    def test_048_attach_cert_parse_error(
        self, mock_mimeapp, mock_serialize, mock_load_x509
    ):
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.MIMEApplication")
    def test_049_attach_cert_serialize_error(
        self, mock_mimeapp, mock_serialize, mock_load_x509
    ):
    ...
    def test_050_format_subject_with_prefix(self):
    ...
    def test_051_format_subject_without_prefix(self):
    ...
    def test_052_format_message_header_success(self):
    ...
    def test_053_format_message_header_failure(self):
    ...
    def test_054_post_hook_success(self, mock_csr_san_get):
    ...
    def test_055_post_hook_report_failures_false(self):
    ...
    def test_056_post_hook_exception(self, mock_csr_san_get):
    ...
    def test_057_success_hook_normal(self, mock_cert_san_get):
    ...
    def test_058_success_hook_report_successes_false(self):
    ...
    def test_059_success_hook_exception(self, mock_cert_san_get):
    ...
    def test_060_success_hook_normal(self, mock_cert_san_get):
        """success_hook sends success email with correct subject and message"""
    ...
    def test_061_success_hook_cert_not_valid_before_utc_exception(
    ...
    def test_063_done_sends_email_with_tls(self, mock_smtp_ssl):
    ...
    def test_064_done_sends_email_with_starttls(self, mock_smtp):
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.smtplib.SMTP")
    def test_065_done_sends_email_without_auth(self, mock_smtp):
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.smtplib.SMTP")
    def test_069_done_smtp_debug_enables_set_debuglevel(self, mock_smtp):
    ...
    def test_070_done_handles_smtp_connection_error(self, mock_smtp_ssl):
    ...
    def test_071_done_handles_smtp_auth_error(self, mock_smtp):
        """_done handles SMTP connection errors gracefully"""
        self.hooks.smtp_use_tls = False
        self.hooks.smtp_use_starttls = False
        self.hooks.smtp_server = "smtp.example.com"
    ...
    @patch("acme2certifier.hookhandlers.email_hooks.smtplib.SMTP")
    def test_072_done_logs_success_info(self, mock_smtp):
    ...
    def test_073_done_already_sent_warning(self):
        """_done warns when called multiple times"""
        self.hooks.done = True
