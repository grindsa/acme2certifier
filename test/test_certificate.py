...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_122_certificate__invalidation_check(self):
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    def test_124_certificate__invalidation_check(self, mock_dates):
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    def test_125_certificate__invalidation_check(self, mock_dates):
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    def test_126_certificate__invalidation_check(self, mock_dates):
    ...
    def test_128_certificate__invalidation_check(self, mock_date):
    ...
    @patch('acme_srv.certificate.date_to_uts_utc')
    def test_129_certificate__invalidation_check(self, mock_date):
    ...
    @patch('acme_srv.certificate.date_to_uts_utc')
    def test_130_certificate__invalidation_check(self, mock_date):
    ...
    def test_135_certificate_poll(self):
    ...
    def test_136_certificate_poll(self):
    ...
    def test_137_certificate__store_cert(self):
    ...
    def test_138_certificate__store_cert_error(self):
    ...
    def test_139_certificate__account_check(self):
    ...
    def test_140_certificate__authorization_check(self):
    ...
    @patch('acme_srv.certificate.Certificate._info')
    def test_141_certificate__csr_check(self, mock_certinfo):
    ...
    def test_142_certificate__info(self):
    ...
    def test_153_certificate_cleanup(self, mock_chk):
    ...
    @patch('acme_srv.certificate.Certificate._invalidation_check')
    def test_154_certificate_cleanup(self, mock_chk):
    ...
    def test_155_certificate_cleanup(self):
    ...
    def test_157_config_load(self, mock_load_cfg):
    ...
    @patch('acme_srv.certificate.load_config')
    def test_158_config_load(self, mock_load_cfg):
    ...
    @patch('acme_srv.certificate.load_config')
    def test_160_config_load(self, mock_load_cfg):
        """ test _config_load missing ca_handler """
        parser = configparser.ConfigParser()
    ...
    @patch('acme_srv.certificate.load_config')
    def test_161_config_load(self, mock_load_cfg, mock_handler):
        """ test _config_load missing ca_handler """
        parser = configparser.ConfigParser()
    ...
    @patch('acme_srv.certificate.load_config')
    def test_162_config_load(self, mock_load_cfg, mock_imp):
        """ test _config_load missing ca_handler """
        parser = configparser.ConfigParser()
        parser['CAhandler'] = {'handler_file': 'foo'}
        mock_load_cfg.return_value = parser
    ...
    @patch('importlib.import_module')
    @patch('acme_srv.certificate.load_config')
    def test_164_config_load(self, mock_load_cfg, mock_imp):
    ...
    @patch('acme_srv.certificate.load_config')
    def test_170_config_load(self, mock_load_cfg):
    ...
    @patch('acme_srv.certificate.load_config')
    def test_171_config_load(self, mock_load_cfg, mock_hooks):
        """ test _config_load enrollment_timeout 120 """
        parser = configparser.ConfigParser()
        parser['Certificate'] = {'enrollment_timeout': 120}
        mock_load_cfg.return_value = parser
    ...
    @patch('acme_srv.certificate.hooks_load')
    @patch('acme_srv.certificate.load_config')
    def test_172_config_load(self, mock_load_cfg, mock_hooks):
        """ test _config_load enrollment_timeout 120 """
        parser = configparser.ConfigParser()
        parser['Certificate'] = {'enrollment_timeout': 120}
        mock_load_cfg.return_value = parser
    ...
    @patch('acme_srv.certificate.hooks_load')
    @patch('acme_srv.certificate.load_config')
    def test_173_config_load(self, mock_load_cfg, mock_hooks):
        """ test _config_load enrollment_timeout 120 """
        parser = configparser.ConfigParser()
        parser['Certificate'] = {'enrollment_timeout': 120}
        mock_load_cfg.return_value = parser
    ...
    @patch('acme_srv.certificate.cert_san_get')
    def test_174_certificate__authorization_check(self, mock_san):
    ...
    @patch('acme_srv.certificate.Certificate._identifer_status_list')
    @patch('acme_srv.certificate.cert_san_get')
    def test_175_certificate__authorization_check(self, mock_san, mock_statlist):
        """ test Certificate.authorization_check - cert_san_get raises exception) """
        self.certificate.dbstore.order_lookup.side_effect = None
        self.certificate.dbstore.order_lookup.return_value = {'identifiers' : 'test'}
        mock_san.return_value = ['foo']
    ...
    @patch('acme_srv.certificate.Certificate._tnauth_identifier_check')
    @patch('acme_srv.certificate.cert_extensions_get')
    def test_176_certificate__authorization_check(self, mock_certext, mock_tnin):
    ...
    @patch('acme_srv.certificate.Certificate._tnauth_identifier_check')
    @patch('acme_srv.certificate.cert_extensions_get')
    def test_177_certificate__authorization_check(self, mock_certext, mock_tnin, mock_tnlist):
    ...
    def test_178_dates_update(self, mock_search):
        """ dates update """
        mock_search.return_value = [{'foo': 'bar'}, {'foo1': 'bar1'}]
        self.certificate.dates_update()

    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_179_dates_update(self, mock_search):
        """ dates update """
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_180_dates_update(self, mock_search, mock_dates_get, mock_store):
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_181_dates_update(self, mock_search, mock_dates_get, mock_store):
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_182_dates_update(self, mock_search, mock_dates_get, mock_store):
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_183_dates_update(self, mock_search, mock_dates_get, mock_store):
        """ dates update call _cert_store """
        mock_search.return_value = [{'issue_uts': 0, 'expire_uts': 0, 'cert_raw': 'cert_raw', 'name': 'name', 'cert': 'cert'}, {'foo1': 'bar1'}]
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_184_dates_update(self, mock_search, mock_dates_get, mock_store):
        """ dates update call _cert_store """
        mock_search.return_value = [{'issue_uts': 0, 'expire_uts': 0, 'cert_raw': 'cert_raw', 'name': 'name', 'cert': 'cert'}, {'foo1': 'bar1'}]
    ...
    @patch('acme_srv.certificate.cert_dates_get')
    @patch('acme_srv.certificate.Certificate.certlist_search')
    def test_185_dates_update(self, mock_search, mock_dates_get, mock_store):
    ...
    def test_186_order_update(self):
    ...
    def test_187_certificate_certlist_search(self):
