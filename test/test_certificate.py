...
class TestACMEHandler(unittest.TestCase):
    ...
    def test_003_certificate__store_cert(self):
        """ test Certificate.store_cert() and check if we get something back """
    ...
    def test_004_certificate__info(self):
    ...
    def test_027_certificate__revocation_request_validate(self):
    ...
    def test_121_certificate_poll(self):
    ...
    def test_123_certificate__store_cert(self):
    ...
    def test_124_certificate__store_cert_error(self):
    ...
    def test_125_certificate__account_check(self):
    ...
    def test_126_certificate__authorization_check(self):
    ...
    def test_128_certificate__info(self):
    ...
    def test_131_certificate_cleanup(self):
    ...
    def test_132_certificate_certlist_search(self):
