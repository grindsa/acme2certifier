...
Installed (DEB/RPM) under `/var/www/acme2certifier/share/` or `/opt/acme2certifier/share/`.
Built-in handlers live in `acme2certifier.{cahandlers,eabhandlers,hookhandlers}`.
